 ...
 * <ul>
 *   <li>{@link org.eclipselabs.spray.shapes.impl.CDPolylineImpl#getLayout <em>Layout</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CDPolylineImpl extends ShapeConnectionImpl implements CDPolyline
{
  ...
  {
    return ShapesPackage.Literals.CD_POLYLINE;
  }
  ...
  public NotificationChain basicSetLayout(PolyLineLayout newLayout, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ShapesPackage.CD_POLYLINE__LAYOUT, oldLayout, newLayout);
  ...
  public void setLayout(PolyLineLayout newLayout)
  {
    if (newLayout != layout)
    {
      ...
      if (layout != null)
        msgs = ((InternalEObject)layout).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ShapesPackage.CD_POLYLINE__LAYOUT, null, msgs);
      if (newLayout != null)
        msgs = ((InternalEObject)newLayout).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ShapesPackage.CD_POLYLINE__LAYOUT, null, msgs);
      msgs = basicSetLayout(newLayout, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapesPackage.CD_POLYLINE__LAYOUT, newLayout, newLayout));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ShapesPackage.CD_POLYLINE__LAYOUT:
