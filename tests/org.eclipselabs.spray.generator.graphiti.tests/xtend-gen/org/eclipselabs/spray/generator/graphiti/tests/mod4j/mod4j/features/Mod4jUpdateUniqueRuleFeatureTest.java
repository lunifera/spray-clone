...
public class Mod4jUpdateUniqueRuleFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jUpdateUniqueRuleFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jUpdateUniqueRuleFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jUpdateUniqueRuleFeature extends Mod4jUpdateUniqueRuleFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jUpdateUniqueRuleFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
