...
public class Mod4jModuleTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jModuleTest"
      + "\nThe method assertEquals is undefined for the type Mod4jModuleTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jModule extends Mod4jModuleBase {");
    _builder.newLine();
    _builder.append("    ");
