...
public class StringPropertyDefaultValueSectionTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type StringPropertyDefaultValueSectionTest"
      + "\nThe method assertEquals is undefined for the type StringPropertyDefaultValueSectionTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class StringPropertyDefaultValueSection extends StringPropertyDefaultValueSectionBase {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
