...
public class BPMN_DataStorageShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public BPMN_DataStorageShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "BPMN_DataStorage.containerShape");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_1.add(gaService.createPoint(0, 10, 5, 30));
        pointList_1.add(gaService.createPoint(25, 0, 20, 20));
        pointList_1.add(gaService.createPoint(50, 10, 30, 5));
        pointList_1.add(gaService.createPoint(50, 40, 0, 0));
        pointList_1.add(gaService.createPoint(25, 50, 20, 20));
        pointList_1.add(gaService.createPoint(0, 40, 0, 0));
        ContainerShape shape_1 = peCreateService.createContainerShape(parentShape, false);
        SprayLayoutService.setId(shape_1, "BPMN_DataStorage.shape_1");
