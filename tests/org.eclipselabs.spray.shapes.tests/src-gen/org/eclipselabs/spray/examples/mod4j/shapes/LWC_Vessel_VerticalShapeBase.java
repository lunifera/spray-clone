...
public class LWC_Vessel_VerticalShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
        shapeName
    }
    
    public LWC_Vessel_VerticalShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "LWC_Vessel_Vertical.containerShape");
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_2, "LWC_Vessel_Vertical.shape_2");
        ...
        gaService.setLocationAndSize(element_2, 3, 20, 100, 20);
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "LWC_Vessel_Vertical.shape_1");
        ...
        SprayLayoutService.setLayoutData(shape_1, 120, 60, true);
