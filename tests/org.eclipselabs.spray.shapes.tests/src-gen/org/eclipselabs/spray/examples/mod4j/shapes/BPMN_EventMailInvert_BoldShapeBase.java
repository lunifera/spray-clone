...
public class BPMN_EventMailInvert_BoldShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public BPMN_EventMailInvert_BoldShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "BPMN_EventMailInvert_Bold.containerShape");
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_2.add(gaService.createPoint(10, 15, 0, 0));
        pointList_2.add(gaService.createPoint(40, 15, 0, 0));
        pointList_2.add(gaService.createPoint(25, 25, 0, 0));
        ContainerShape shape_2 = peCreateService.createContainerShape(parentShape, false);
        SprayLayoutService.setId(shape_2, "BPMN_EventMailInvert_Bold.shape_2");
        ...
        element_2.setForeground(gaService.manageColor(diagram,IColorConstant.WHITE));
    ...
    protected Shape createElement_3(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_3.add(gaService.createPoint(10, 18, 0, 0));
        pointList_3.add(gaService.createPoint(10, 36, 0, 0));
        pointList_3.add(gaService.createPoint(40, 36, 0, 0));
        pointList_3.add(gaService.createPoint(40, 18, 0, 0));
        pointList_3.add(gaService.createPoint(25, 28, 0, 0));
        ContainerShape shape_3 = peCreateService.createContainerShape(parentShape, false);
        SprayLayoutService.setId(shape_3, "BPMN_EventMailInvert_Bold.shape_3");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "BPMN_EventMailInvert_Bold.shape_1");
