 ...
 *   <li>{@link BusinessDomainDsl.impl.BusinessDomainModelImpl#getPackages <em>Packages</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BusinessDomainModelImpl extends ModelElementImpl implements BusinessDomainModel
{
   ...
   * @ordered
   */
  protected EList<BusinessDomainDsl.Package> packages;
   ...
   * @generated
   */
  public EList<BusinessDomainDsl.Package> getPackages()
  {
    if (packages == null)
    {
      packages = new EObjectContainmentEList<BusinessDomainDsl.Package>(BusinessDomainDsl.Package.class, this, BusinessDomainDslPackage.BUSINESS_DOMAIN_MODEL__PACKAGES);
    }
    return packages;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case BusinessDomainDslPackage.BUSINESS_DOMAIN_MODEL__PACKAGES:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case BusinessDomainDslPackage.BUSINESS_DOMAIN_MODEL__PACKAGES:
        getPackages().clear();
        getPackages().addAll((Collection<? extends BusinessDomainDsl.Package>)newValue);
        return;
    }
