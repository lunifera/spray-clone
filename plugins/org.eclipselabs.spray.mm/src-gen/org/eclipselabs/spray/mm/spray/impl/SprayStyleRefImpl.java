 ...
 * <ul>
 *   <li>{@link org.eclipselabs.spray.mm.spray.impl.SprayStyleRefImpl#getJavaStyle <em>Java Style</em>}</li>
 *   <li>{@link org.eclipselabs.spray.mm.spray.impl.SprayStyleRefImpl#getDslStyle <em>Dsl Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SprayStyleRefImpl extends MinimalEObjectImpl.Container implements SprayStyleRef
{
  ...
  {
    return SprayPackage.Literals.SPRAY_STYLE_REF;
  }
  ...
  public NotificationChain basicSetJavaStyle(JvmTypeReference newJavaStyle, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SprayPackage.SPRAY_STYLE_REF__JAVA_STYLE, oldJavaStyle, newJavaStyle);
  ...
  public void setJavaStyle(JvmTypeReference newJavaStyle)
  {
    if (newJavaStyle != javaStyle)
    {
      ...
      if (javaStyle != null)
        msgs = ((InternalEObject)javaStyle).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SprayPackage.SPRAY_STYLE_REF__JAVA_STYLE, null, msgs);
      if (newJavaStyle != null)
        msgs = ((InternalEObject)newJavaStyle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SprayPackage.SPRAY_STYLE_REF__JAVA_STYLE, null, msgs);
      msgs = basicSetJavaStyle(newJavaStyle, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SprayPackage.SPRAY_STYLE_REF__JAVA_STYLE, newJavaStyle, newJavaStyle));
  }
  ...
  public Style getDslStyle()
  {
    if (dslStyle != null && dslStyle.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SprayPackage.SPRAY_STYLE_REF__DSL_STYLE, oldDslStyle, dslStyle));
      }
    }
    return dslStyle;
  }
  ...
  public void setDslStyle(Style newDslStyle)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SprayPackage.SPRAY_STYLE_REF__DSL_STYLE, oldDslStyle, dslStyle));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SprayPackage.SPRAY_STYLE_REF__JAVA_STYLE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SprayPackage.SPRAY_STYLE_REF__JAVA_STYLE:
        return getJavaStyle();
      case SprayPackage.SPRAY_STYLE_REF__DSL_STYLE:
