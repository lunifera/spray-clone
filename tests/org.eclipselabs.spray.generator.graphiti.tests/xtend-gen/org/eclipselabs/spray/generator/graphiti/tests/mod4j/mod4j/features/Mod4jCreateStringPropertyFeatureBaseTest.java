...
public class Mod4jCreateStringPropertyFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jCreateStringPropertyFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jCreateStringPropertyFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class Mod4jCreateStringPropertyFeatureBase extends AbstractCreateFeature {");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected StringProperty newClass = null;");
    _builder.newLine();
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jCreateStringPropertyFeatureBase (final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("// set name and description of the creation feature");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("super(fp, \"StringProperty\", \"Create new StringProperty\");");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("newClass = createStringProperty(context);");
    _builder.newLine();
    _builder.append("    ");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("             ");
    _builder.append("* Creates a new {@link StringProperty} instance and adds it to the containing type.");
    _builder.newLine();
    _builder.append("             ");
    _builder.append("*/");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("protected StringProperty createStringProperty(final ICreateContext context) {");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("// create StringProperty instance");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("final StringProperty newClass = BusinessDomainDslFactory.eINSTANCE.createStringProperty();");
    _builder.newLine();
    _builder.append("                ");
