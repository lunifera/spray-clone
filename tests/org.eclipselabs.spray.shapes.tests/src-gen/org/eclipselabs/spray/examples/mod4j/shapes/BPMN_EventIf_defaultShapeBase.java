...
public class BPMN_EventIf_defaultShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public BPMN_EventIf_defaultShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "BPMN_EventIf_default.containerShape");
    ...
    protected Shape createElement_3(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_3.add(gaService.createPoint(2, 2, 0, 0));
        pointList_3.add(gaService.createPoint(18, 2, 0, 0));
        Shape shape_3 = peCreateService.createShape(parentShape, false);
        SprayLayoutService.setId(shape_3, "BPMN_EventIf_default.shape_3");
    ...
    protected Shape createElement_4(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_4.add(gaService.createPoint(2, 8, 0, 0));
        pointList_4.add(gaService.createPoint(18, 8, 0, 0));
        Shape shape_4 = peCreateService.createShape(parentShape, false);
        SprayLayoutService.setId(shape_4, "BPMN_EventIf_default.shape_4");
    ...
    protected Shape createElement_5(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_5.add(gaService.createPoint(2, 16, 0, 0));
        pointList_5.add(gaService.createPoint(18, 16, 0, 0));
        Shape shape_5 = peCreateService.createShape(parentShape, false);
        SprayLayoutService.setId(shape_5, "BPMN_EventIf_default.shape_5");
    ...
    protected Shape createElement_6(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_6.add(gaService.createPoint(2, 22, 0, 0));
        pointList_6.add(gaService.createPoint(18, 22, 0, 0));
        Shape shape_6 = peCreateService.createShape(parentShape, false);
        SprayLayoutService.setId(shape_6, "BPMN_EventIf_default.shape_6");
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_2, "BPMN_EventIf_default.shape_2");
        ...
        gaService.setLocationAndSize(element_2, 15, 12, 20, 25);
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "BPMN_EventIf_default.shape_1");
