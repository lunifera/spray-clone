...
/**
 * This is a generated Style class for Spray.
 * Description: This is a description for the NoFontnameAndSize
 */
@SuppressWarnings("all")
public class NoFontnameAndSizeBase extends org.eclipselabs.spray.runtime.graphiti.styles.DefaultSprayStyle {
    ...
    public Style newStyle(Diagram diagram) {
        ...
        style.setId("NoFontnameAndSize");
        style.setDescription("This is a description for the NoFontnameAndSize");
    ...
    public Color getFontColor(Diagram diagram) {
        ...
        return gaService.manageColor(diagram, IColorConstant.LIGHT_LIGHT_GRAY);
    }
