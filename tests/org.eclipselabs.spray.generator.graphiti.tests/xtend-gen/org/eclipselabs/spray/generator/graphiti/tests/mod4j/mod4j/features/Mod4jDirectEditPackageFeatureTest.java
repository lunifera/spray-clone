...
public class Mod4jDirectEditPackageFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jDirectEditPackageFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jDirectEditPackageFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jDirectEditPackageFeature extends Mod4jDirectEditPackageFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jDirectEditPackageFeature(IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
