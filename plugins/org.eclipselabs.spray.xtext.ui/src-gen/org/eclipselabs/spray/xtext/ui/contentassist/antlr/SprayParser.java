...
* generated by Xtext
*/
package org.eclipselabs.spray.xtext.ui.contentassist.antlr;
...
public class SprayParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipselabs.spray.xtext.ui.contentassist.antlr.internal.InternalSprayParser createParser() {
		org.eclipselabs.spray.xtext.ui.contentassist.antlr.internal.InternalSprayParser result = new org.eclipselabs.spray.xtext.ui.contentassist.antlr.internal.InternalSprayParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getMetaClassAccess().getAlternatives_8_2(), "rule__MetaClass__Alternatives_8_2");
					put(grammarAccess.getBehaviorAccess().getAlternatives(), "rule__Behavior__Alternatives");
					put(grammarAccess.getCustomBehaviorAccess().getAlternatives_1(), "rule__CustomBehavior__Alternatives_1");
					put(grammarAccess.getShapeInSprayAccess().getAlternatives(), "rule__ShapeInSpray__Alternatives");
					put(grammarAccess.getShapeReferenceAccess().getAlternatives(), "rule__ShapeReference__Alternatives");
					put(grammarAccess.getConnectionReferenceAccess().getAlternatives(), "rule__ConnectionReference__Alternatives");
					put(grammarAccess.getSprayStyleRefAccess().getAlternatives_1(), "rule__SprayStyleRef__Alternatives_1");
					put(grammarAccess.getShapePropertyAssignmentAccess().getAlternatives(), "rule__ShapePropertyAssignment__Alternatives");
					put(grammarAccess.getShapeDslKeyAccess().getAlternatives(), "rule__ShapeDslKey__Alternatives");
					...
					put(grammarAccess.getSprayQualifiedNameWithWildCardAccess().getGroup(), "rule__SprayQualifiedNameWithWildCard__Group__0");
					put(grammarAccess.getSprayQualifiedNameWithWildCardAccess().getGroup_1(), "rule__SprayQualifiedNameWithWildCard__Group_1__0");
					...
					put(grammarAccess.getMetaClassAccess().getGroup_7_2(), "rule__MetaClass__Group_7_2__0");
					put(grammarAccess.getMetaClassAccess().getGroup_8(), "rule__MetaClass__Group_8__0");
					put(grammarAccess.getMetaClassAccess().getGroup_8_2_0(), "rule__MetaClass__Group_8_2_0__0");
					put(grammarAccess.getMetaClassAccess().getGroup_8_2_1(), "rule__MetaClass__Group_8_2_1__0");
					put(grammarAccess.getMetaReference2Access().getGroup(), "rule__MetaReference2__Group__0");
					put(grammarAccess.getBehaviorGroupAccess().getGroup(), "rule__BehaviorGroup__Group__0");
					put(grammarAccess.getBehaviorGroupAccess().getGroup_3(), "rule__BehaviorGroup__Group_3__0");
					put(grammarAccess.getCreateBehaviorAccess().getGroup(), "rule__CreateBehavior__Group__0");
					put(grammarAccess.getCreateBehaviorAccess().getGroup_2(), "rule__CreateBehavior__Group_2__0");
					put(grammarAccess.getCreateBehaviorAccess().getGroup_3(), "rule__CreateBehavior__Group_3__0");
					put(grammarAccess.getCreateBehaviorAccess().getGroup_4(), "rule__CreateBehavior__Group_4__0");
					put(grammarAccess.getCustomBehaviorAccess().getGroup(), "rule__CustomBehavior__Group__0");
					put(grammarAccess.getCustomBehaviorAccess().getGroup_1_1(), "rule__CustomBehavior__Group_1_1__0");
					put(grammarAccess.getShapeFromDslAccess().getGroup(), "rule__ShapeFromDsl__Group__0");
					put(grammarAccess.getShapeFromDslAccess().getGroup_3(), "rule__ShapeFromDsl__Group_3__0");
					put(grammarAccess.getShapeReferenceAccess().getGroup_0(), "rule__ShapeReference__Group_0__0");
					put(grammarAccess.getConnectionReferenceAccess().getGroup_0(), "rule__ConnectionReference__Group_0__0");
					put(grammarAccess.getSprayStyleRefAccess().getGroup(), "rule__SprayStyleRef__Group__0");
					put(grammarAccess.getSprayStyleRefAccess().getGroup_1_0(), "rule__SprayStyleRef__Group_1_0__0");
					put(grammarAccess.getShapePropertyAssignmentAccess().getGroup_0(), "rule__ShapePropertyAssignment__Group_0__0");
					put(grammarAccess.getShapePropertyAssignmentAccess().getGroup_0_3(), "rule__ShapePropertyAssignment__Group_0_3__0");
					put(grammarAccess.getShapePropertyAssignmentAccess().getGroup_1(), "rule__ShapePropertyAssignment__Group_1__0");
					put(grammarAccess.getShapeDslKeyAccess().getGroup_0(), "rule__ShapeDslKey__Group_0__0");
					put(grammarAccess.getShapeCompartmentAssignmentAccess().getGroup(), "rule__ShapeCompartmentAssignment__Group__0");
					put(grammarAccess.getShapeCompartmentAssignmentAccess().getGroup_4(), "rule__ShapeCompartmentAssignment__Group_4__0");
					put(grammarAccess.getConnectionInSprayAccess().getGroup(), "rule__ConnectionInSpray__Group__0");
					put(grammarAccess.getConnectionInSprayAccess().getGroup_2(), "rule__ConnectionInSpray__Group_2__0");
					put(grammarAccess.getConnectionInSprayAccess().getGroup_2_1(), "rule__ConnectionInSpray__Group_2_1__0");
					put(grammarAccess.getConnectionInSprayAccess().getGroup_3(), "rule__ConnectionInSpray__Group_3__0");
					put(grammarAccess.getConnectionInSprayAccess().getGroup_4(), "rule__ConnectionInSpray__Group_4__0");
					...
					put(grammarAccess.getDiagramAccess().getModelTypeAssignment_4(), "rule__Diagram__ModelTypeAssignment_4");
					put(grammarAccess.getDiagramAccess().getStyleAssignment_5(), "rule__Diagram__StyleAssignment_5");
					put(grammarAccess.getDiagramAccess().getBehaviourGroupsAssignment_6(), "rule__Diagram__BehaviourGroupsAssignment_6");
					put(grammarAccess.getDiagramAccess().getMetaClassesAssignment_7(), "rule__Diagram__MetaClassesAssignment_7");
					put(grammarAccess.getImportAccess().getImportedNamespaceAssignment_1(), "rule__Import__ImportedNamespaceAssignment_1");
					put(grammarAccess.getMetaClassAccess().getTypeAssignment_1(), "rule__MetaClass__TypeAssignment_1");
					...
					put(grammarAccess.getMetaClassAccess().getStyleAssignment_4(), "rule__MetaClass__StyleAssignment_4");
					put(grammarAccess.getMetaClassAccess().getRepresentedByAssignment_6(), "rule__MetaClass__RepresentedByAssignment_6");
					put(grammarAccess.getMetaClassAccess().getReferencesAssignment_7_2_0(), "rule__MetaClass__ReferencesAssignment_7_2_0");
					put(grammarAccess.getMetaClassAccess().getBehaviorGroupsAssignment_8_2_0_1(), "rule__MetaClass__BehaviorGroupsAssignment_8_2_0_1");
					put(grammarAccess.getMetaClassAccess().getBehaviorsAssignment_8_2_1_0(), "rule__MetaClass__BehaviorsAssignment_8_2_1_0");
					put(grammarAccess.getMetaReference2Access().getTargetAssignment_0(), "rule__MetaReference2__TargetAssignment_0");
					put(grammarAccess.getMetaReference2Access().getRepresentedByAssignment_2(), "rule__MetaReference2__RepresentedByAssignment_2");
					put(grammarAccess.getBehaviorGroupAccess().getNameAssignment_1(), "rule__BehaviorGroup__NameAssignment_1");
					put(grammarAccess.getBehaviorGroupAccess().getBehaviorsAssignment_3_0(), "rule__BehaviorGroup__BehaviorsAssignment_3_0");
					put(grammarAccess.getCreateBehaviorAccess().getContainmentReferenceAssignment_2_1(), "rule__CreateBehavior__ContainmentReferenceAssignment_2_1");
					put(grammarAccess.getCreateBehaviorAccess().getLabelAssignment_2_2(), "rule__CreateBehavior__LabelAssignment_2_2");
					put(grammarAccess.getCreateBehaviorAccess().getPaletteCompartmentAssignment_3_1(), "rule__CreateBehavior__PaletteCompartmentAssignment_3_1");
					put(grammarAccess.getCreateBehaviorAccess().getAskForAssignment_4_1(), "rule__CreateBehavior__AskForAssignment_4_1");
					put(grammarAccess.getCustomBehaviorAccess().getNameAssignment_1_0(), "rule__CustomBehavior__NameAssignment_1_0");
					put(grammarAccess.getCustomBehaviorAccess().getRealizedByAssignment_1_1_1(), "rule__CustomBehavior__RealizedByAssignment_1_1_1");
					put(grammarAccess.getCustomBehaviorAccess().getLabelAssignment_2(), "rule__CustomBehavior__LabelAssignment_2");
					put(grammarAccess.getShapeFromDslAccess().getShapeAssignment_2(), "rule__ShapeFromDsl__ShapeAssignment_2");
					put(grammarAccess.getShapeFromDslAccess().getPropertiesAssignment_3_1(), "rule__ShapeFromDsl__PropertiesAssignment_3_1");
					put(grammarAccess.getShapeFromDslAccess().getReferencesAssignment_3_2(), "rule__ShapeFromDsl__ReferencesAssignment_3_2");
					put(grammarAccess.getShapeReferenceAccess().getJvmShapeAssignment_0_1(), "rule__ShapeReference__JvmShapeAssignment_0_1");
					put(grammarAccess.getShapeReferenceAccess().getDslShapeAssignment_1(), "rule__ShapeReference__DslShapeAssignment_1");
					put(grammarAccess.getConnectionReferenceAccess().getJvmConnectionAssignment_0_1(), "rule__ConnectionReference__JvmConnectionAssignment_0_1");
					put(grammarAccess.getConnectionReferenceAccess().getDslConnectionAssignment_1(), "rule__ConnectionReference__DslConnectionAssignment_1");
					put(grammarAccess.getSprayStyleRefAccess().getJavaStyleAssignment_1_0_1(), "rule__SprayStyleRef__JavaStyleAssignment_1_0_1");
					put(grammarAccess.getSprayStyleRefAccess().getDslStyleAssignment_1_1(), "rule__SprayStyleRef__DslStyleAssignment_1_1");
					put(grammarAccess.getShapePropertyAssignmentAccess().getAttributeAssignment_0_0(), "rule__ShapePropertyAssignment__AttributeAssignment_0_0");
					put(grammarAccess.getShapePropertyAssignmentAccess().getKeyAssignment_0_2(), "rule__ShapePropertyAssignment__KeyAssignment_0_2");
					put(grammarAccess.getShapePropertyAssignmentAccess().getValueAssignment_0_3_1(), "rule__ShapePropertyAssignment__ValueAssignment_0_3_1");
					put(grammarAccess.getShapePropertyAssignmentAccess().getValueAssignment_1_1(), "rule__ShapePropertyAssignment__ValueAssignment_1_1");
					put(grammarAccess.getShapePropertyAssignmentAccess().getKeyAssignment_1_3(), "rule__ShapePropertyAssignment__KeyAssignment_1_3");
					put(grammarAccess.getShapeDslKeyAccess().getJvmKeyAssignment_0_1(), "rule__ShapeDslKey__JvmKeyAssignment_0_1");
					put(grammarAccess.getShapeDslKeyAccess().getDslKeyAssignment_1(), "rule__ShapeDslKey__DslKeyAssignment_1");
					put(grammarAccess.getShapeCompartmentAssignmentAccess().getReferenceAssignment_1(), "rule__ShapeCompartmentAssignment__ReferenceAssignment_1");
					put(grammarAccess.getShapeCompartmentAssignmentAccess().getShapeDslKeyAssignment_3(), "rule__ShapeCompartmentAssignment__ShapeDslKeyAssignment_3");
					put(grammarAccess.getShapeCompartmentAssignmentAccess().getValueAssignment_4_1(), "rule__ShapeCompartmentAssignment__ValueAssignment_4_1");
					put(grammarAccess.getConnectionInSprayAccess().getConnectionAssignment_2_0(), "rule__ConnectionInSpray__ConnectionAssignment_2_0");
					put(grammarAccess.getConnectionInSprayAccess().getPropertiesAssignment_2_1_1(), "rule__ConnectionInSpray__PropertiesAssignment_2_1_1");
					put(grammarAccess.getConnectionInSprayAccess().getAliasAssignment_3_1(), "rule__ConnectionInSpray__AliasAssignment_3_1");
					put(grammarAccess.getConnectionInSprayAccess().getFromAssignment_4_2(), "rule__ConnectionInSpray__FromAssignment_4_2");
					put(grammarAccess.getConnectionInSprayAccess().getToAssignment_4_5(), "rule__ConnectionInSpray__ToAssignment_4_5");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipselabs.spray.xtext.ui.contentassist.antlr.internal.InternalSprayParser typedParser = (org.eclipselabs.spray.xtext.ui.contentassist.antlr.internal.InternalSprayParser) parser;
