...
public class LWC_Vessel_HorizontalShapeBase extends DefaultSprayShape {
    ...
    public LWC_Vessel_HorizontalShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "LWC_Vessel_Horizontal.containerShape");
    ...
    protected void createCascadedElements(Diagram diagram, ContainerShape containerShape, ISprayStyle sprayStyle) {
        ...
        gaService.setLocationAndSize(element_0, 0, 0, 60, 120);
        
        
        createElement_1(diagram, containerShape, sprayStyle);
        
        Shape shape_2 = peCreateService.createShape(containerShape, false);
        ...
        gaService.setLocationAndSize(element_2, 0, 120, 60, 20);
        element_2.setHorizontalAlignment(Orientation.ALIGNMENT_CENTER);
        element_2.setVerticalAlignment(Orientation.ALIGNMENT_MIDDLE);
        peService.setPropertyValue(element_2, ISprayConstants.TEXT_ID, TextIds.descriptionName.name());
        element_2.setValue("");
        directEditingInfo.setPictogramElement(shape_2);
        directEditingInfo.setGraphicsAlgorithm(element_2);
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_2, "LWC_Vessel_Horizontal.shape_2");
        Text element_2 = gaService.createPlainText(shape_2);
        ISprayStyle style_2 = sprayStyle;
        element_2.setStyle(style_2.getStyle(diagram));
        gaService.setLocationAndSize(element_2, 3, 50, 60, 20);
        SprayLayoutService.setLayoutData(shape_2, 60, 20, true);
        element_2.setHorizontalAlignment(Orientation.ALIGNMENT_LEFT);
        element_2.setVerticalAlignment(Orientation.ALIGNMENT_TOP);
        peService.setPropertyValue(element_2, ISprayConstants.TEXT_ID, TextIds.shapeName.name());
        peService.setPropertyValue(shape_2, ISprayConstants.TEXT_ID, TextIds.shapeName.name());
        element_2.setValue("");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "LWC_Vessel_Horizontal.shape_1");
        RoundedRectangle element_1 = gaService.createPlainRoundedRectangle(shape_1, 50, 50);
        ISprayStyle style_1 = sprayStyle;
        element_1.setStyle(style_1.getStyle(diagram));
        gaService.setLocationAndSize(element_1, 0, 0, 60, 120);
        SprayLayoutService.setLayoutData(shape_1, 60, 120, true);
