...
public class BPMN_EventCompensation_DoubleInvertShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public BPMN_EventCompensation_DoubleInvertShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "BPMN_EventCompensation_DoubleInvert.containerShape");
    ...
    protected Shape createElement_3(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_3.add(gaService.createPoint(20, 13, 0, 0));
        pointList_3.add(gaService.createPoint(20, 33, 0, 0));
        pointList_3.add(gaService.createPoint(5, 23, 0, 0));
        ContainerShape shape_3 = peCreateService.createContainerShape(parentShape, false);
        SprayLayoutService.setId(shape_3, "BPMN_EventCompensation_DoubleInvert.shape_3");
    ...
    protected Shape createElement_4(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_4.add(gaService.createPoint(20, 23, 0, 0));
        pointList_4.add(gaService.createPoint(35, 13, 0, 0));
        pointList_4.add(gaService.createPoint(35, 33, 0, 0));
        ContainerShape shape_4 = peCreateService.createContainerShape(parentShape, false);
        SprayLayoutService.setId(shape_4, "BPMN_EventCompensation_DoubleInvert.shape_4");
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_2, "BPMN_EventCompensation_DoubleInvert.shape_2");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "BPMN_EventCompensation_DoubleInvert.shape_1");
