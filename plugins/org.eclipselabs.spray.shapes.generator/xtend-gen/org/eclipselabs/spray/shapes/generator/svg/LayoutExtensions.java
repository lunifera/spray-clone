...
public class LayoutExtensions {
  ...
  public Integer minXPoint(final List<Point> points) {
    ...
    List<Integer> _findPoint = this.findPoint(points, _function, _function_1);
  ...
  public List<Integer> findPoint(final List<Point> points, final Function1<? super Point,? extends Integer> coord, final Function2<? super Integer,? super Integer,? extends Integer> compare) {
    final Function1<Point,Integer> _function = new Function1<Point,Integer>() {
      public Integer apply(final Point p) {
    ...
    return IterableExtensions.<Integer>sort(_map, _function_1);
  }
  
  protected String _lineStyle(final ConnectionDefinition shape) {
    ShapestyleLayout _layout = shape.getLayout();
    StyleLayout _layout_1 = null;
    if (_layout!=null) {
      _layout_1=_layout.getLayout();
    }
    return this.internalLineStyle(_layout_1);
  }
  
  protected String _lineStyle(final Line shape) {
    LineLayout _layout = shape.getLayout();
    ShapestyleLayout _layout_1 = null;
    if (_layout!=null) {
      _layout_1=_layout.getLayout();
    }
    StyleLayout _layout_2 = null;
    if (_layout_1!=null) {
      _layout_2=_layout_1.getLayout();
    }
    return this.internalLineStyle(_layout_2);
  }
  ...
  protected String _lineStyle(final ShapestyleLayout layout) {
    StyleLayout _layout = null;
    if (layout!=null) {
      _layout=layout.getLayout();
    }
    return this.internalLineStyle(_layout);
  }
  ...
  public boolean hasTransparency(final ShapestyleLayout ssl) {
    ...
    double _transparency = _layout.getTransparency();
    return (_transparency != Double.MIN_VALUE);
  }
  
  public double transparency(final ShapestyleLayout ssl) {
    StyleLayout _layout = ssl.getLayout();
    return _layout.getTransparency();
  }
