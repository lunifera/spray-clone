...
public class Mod4jCreateUniqueRuleFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jCreateUniqueRuleFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jCreateUniqueRuleFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class Mod4jCreateUniqueRuleFeatureBase extends AbstractCreateFeature {");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected UniqueRule newClass = null;");
    _builder.newLine();
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jCreateUniqueRuleFeatureBase (final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("// set name and description of the creation feature");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("super(fp, \"UniqueRule\", \"Create new UniqueRule\");");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("newClass = createUniqueRule(context);");
    _builder.newLine();
    _builder.append("    ");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("             ");
    _builder.append("* Creates a new {@link UniqueRule} instance and adds it to the containing type.");
    _builder.newLine();
    _builder.append("             ");
    _builder.append("*/");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("protected UniqueRule createUniqueRule(final ICreateContext context) {");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("// create UniqueRule instance");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("final UniqueRule newClass = BusinessDomainDslFactory.eINSTANCE.createUniqueRule();");
    _builder.newLine();
    _builder.append("                ");
