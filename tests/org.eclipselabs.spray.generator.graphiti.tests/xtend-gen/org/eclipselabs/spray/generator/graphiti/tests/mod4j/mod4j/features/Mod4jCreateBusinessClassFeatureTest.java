...
public class Mod4jCreateBusinessClassFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jCreateBusinessClassFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jCreateBusinessClassFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jCreateBusinessClassFeature extends Mod4jCreateBusinessClassFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jCreateBusinessClassFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
