...
public class Mod4jUpdateBusinessRuleFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jUpdateBusinessRuleFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jUpdateBusinessRuleFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jUpdateBusinessRuleFeature extends Mod4jUpdateBusinessRuleFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jUpdateBusinessRuleFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
