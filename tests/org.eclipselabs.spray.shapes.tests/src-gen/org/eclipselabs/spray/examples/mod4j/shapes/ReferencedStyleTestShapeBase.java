...
public class ReferencedStyleTestShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public ReferencedStyleTestShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "ReferencedStyleTest.containerShape");
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_2, "ReferencedStyleTest.shape_2");
        SprayLayoutService.setCompartment(shape_2, false);
        Rectangle element_2 = gaService.createPlainRectangle(shape_2);
        ISprayStyle style_2 = new org.eclipselabs.spray.runtime.graphiti.styles.DefaultSprayStyle();
        element_2.setStyle(style_2.getStyle(diagram));
        gaService.setLocationAndSize(element_2, 0, 0, 10, 10);
        SprayLayoutService.setLayoutData(shape_2, 10, 10, true);
        return shape_2;
    }
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "ReferencedStyleTest.shape_1");
