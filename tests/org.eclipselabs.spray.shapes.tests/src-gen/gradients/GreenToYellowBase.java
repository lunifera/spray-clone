...
public class GreenToYellowBase extends PredefinedColoredAreas implements ISprayGradient {
     ...
     */
     public GradientColoredAreas getGradientColoredAreas( ) {
         ...
         addGradientColoredArea(gcas,"00FF00",0,org.eclipse.graphiti.mm.algorithms.styles.LocationType.LOCATION_TYPE_RELATIVE, "FFFF00",100,org.eclipse.graphiti.mm.algorithms.styles.LocationType.LOCATION_TYPE_RELATIVE);
