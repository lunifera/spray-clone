...
public class BPMN_EventLink_triggeredShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public BPMN_EventLink_triggeredShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "BPMN_EventLink_triggered.containerShape");
    ...
    protected Shape createElement_3(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_3.add(gaService.createPoint(28, 8, 0, 0));
        pointList_3.add(gaService.createPoint(38, 23, 0, 0));
        pointList_3.add(gaService.createPoint(28, 38, 0, 0));
        pointList_3.add(gaService.createPoint(28, 29, 0, 0));
        pointList_3.add(gaService.createPoint(8, 29, 0, 0));
        pointList_3.add(gaService.createPoint(8, 17, 0, 0));
        pointList_3.add(gaService.createPoint(28, 17, 0, 0));
        ContainerShape shape_3 = peCreateService.createContainerShape(parentShape, false);
        SprayLayoutService.setId(shape_3, "BPMN_EventLink_triggered.shape_3");
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_2, "BPMN_EventLink_triggered.shape_2");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "BPMN_EventLink_triggered.shape_1");
