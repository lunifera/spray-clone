...
public class ReferencedStyleOnShapeTestShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public ReferencedStyleOnShapeTestShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "ReferencedStyleOnShapeTest.containerShape");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "ReferencedStyleOnShapeTest.shape_1");
