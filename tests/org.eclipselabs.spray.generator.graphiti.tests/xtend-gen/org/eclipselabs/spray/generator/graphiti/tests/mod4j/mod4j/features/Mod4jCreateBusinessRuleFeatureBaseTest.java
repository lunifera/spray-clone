...
public class Mod4jCreateBusinessRuleFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jCreateBusinessRuleFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jCreateBusinessRuleFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class Mod4jCreateBusinessRuleFeatureBase extends AbstractCreateFeature {");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jCreateBusinessRuleFeatureBase (final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("// set name and description of the creation feature");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("super(fp, \"BusinessRule\", \"Create new BusinessRule\");");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("newClass = createBusinessRule(context);");
    _builder.newLine();
    _builder.append("    ");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("            ");
    _builder.append("protected BusinessRule createBusinessRule(final ICreateContext context) {");
    _builder.newLine();
    _builder.append("                ");
