...
public class Mod4jUpdateSimpleClassFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jUpdateSimpleClassFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jUpdateSimpleClassFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class Mod4jUpdateSimpleClassFeatureBase extends AbstractUpdateFeature {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jUpdateSimpleClassFeatureBase(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
