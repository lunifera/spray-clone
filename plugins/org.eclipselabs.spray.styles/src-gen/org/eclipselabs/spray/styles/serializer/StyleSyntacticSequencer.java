...
public class StyleSyntacticSequencer extends AbstractSyntacticSequencer {

	protected StyleGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (StyleGrammarAccess) access;
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if(match_GradientColorArea_RightParenthesisKeyword_9_p.equals(syntax))
