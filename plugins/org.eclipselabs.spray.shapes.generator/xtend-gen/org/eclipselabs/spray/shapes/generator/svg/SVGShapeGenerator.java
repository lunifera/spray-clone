...
public class SVGShapeGenerator {
  ...
  protected CharSequence handleBackground(final ShapestyleLayout ssl) {
    ...
    {
      StyleLayout _layout = ssl.getLayout();
      ColorOrGradient _background = _layout.getBackground();
      boolean _notEquals = (!Objects.equal(_background, null));
      if (_notEquals) {
        _builder.append("fill:");
        StyleLayout _layout_1 = ssl.getLayout();
        CharSequence _backgroundColor = this.backgroundColor(_layout_1);
  ...
  protected CharSequence handleOpacity(final ShapestyleLayout ssl) {
    StringConcatenation _builder = new StringConcatenation();
    {
      ...
      if (_hasTransparency) {
        ...
        double _transparency = this._layoutExtensions.transparency(ssl);
  ...
  protected CharSequence handleStrokeWidth(final ShapestyleLayout ssl) {
    StringConcatenation _builder = new StringConcatenation();
    {
      ...
      boolean _greaterThan = (_lineWidth > 1);
      if (_greaterThan) {
  ...
  protected CharSequence handleStrokeColor(final ShapestyleLayout ssl) {
    StringConcatenation _builder = new StringConcatenation();
    {
      ...
      if (_notEquals) {
        ...
        StyleLayout _layout_1 = ssl.getLayout();
        CharSequence _color = this.color(_layout_1);
