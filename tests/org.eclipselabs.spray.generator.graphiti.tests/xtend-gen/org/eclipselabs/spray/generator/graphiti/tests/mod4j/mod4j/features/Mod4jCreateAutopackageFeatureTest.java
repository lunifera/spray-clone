...
public class Mod4jCreateAutopackageFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jCreateAutopackageFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jCreateAutopackageFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jCreateAutopackageFeature extends Mod4jCreateAutopackageFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jCreateAutopackageFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
