...
public class StringPropertyHasDefaultSectionTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type StringPropertyHasDefaultSectionTest"
      + "\nThe method assertEquals is undefined for the type StringPropertyHasDefaultSectionTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class StringPropertyHasDefaultSection extends StringPropertyHasDefaultSectionBase {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
