...
public class BoolPropertyFilterTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type BoolPropertyFilterTest"
      + "\nThe method assertEquals is undefined for the type BoolPropertyFilterTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class BoolPropertyFilter extends BoolPropertyFilterBase {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
