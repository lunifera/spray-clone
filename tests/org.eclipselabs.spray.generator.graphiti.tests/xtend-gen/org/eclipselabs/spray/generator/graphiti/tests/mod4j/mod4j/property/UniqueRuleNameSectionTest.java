...
public class UniqueRuleNameSectionTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type UniqueRuleNameSectionTest"
      + "\nThe method assertEquals is undefined for the type UniqueRuleNameSectionTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class UniqueRuleNameSection extends UniqueRuleNameSectionBase {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
