...
import org.eclipselabs.spray.examples.mod4j.styles.A3;
...
public class B2Base extends A3 {
    ...
    public AdaptedGradientColoredAreas getColorSchema() {
        ...
        agca.setDefinedStyleId("B2Base_Color_Schema_ID");
        agca.setGradientType(IGradientType.HORIZONTAL);
        agca.getAdaptedGradientColoredAreas().add(IPredefinedRenderingStyle.STYLE_ADAPTATION_DEFAULT, new gradients.C1().getGradientColoredAreas( ));
        return agca;
    }
}
