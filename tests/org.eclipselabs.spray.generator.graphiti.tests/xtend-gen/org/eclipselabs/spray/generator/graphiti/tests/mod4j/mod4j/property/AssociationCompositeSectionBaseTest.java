...
public class AssociationCompositeSectionBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type AssociationCompositeSectionBaseTest"
      + "\nThe method assertEquals is undefined for the type AssociationCompositeSectionBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class AssociationCompositeSectionBase extends GFPropertySection implements ITabbedPropertyConstants {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected CCombo      compositeWidget;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("/**");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("compositeWidget = factory.createCCombo(composite);");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("compositeWidget.setLayoutData(data);");
    _builder.newLine();
    _builder.newLine();
    _builder.append("        ");
    _builder.append("CLabel valueLabel = factory.createCLabel(composite, \"Composite\");");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("data = new FormData();");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("data.right = new FormAttachment(compositeWidget, -HSPACE);");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("data.top = new FormAttachment(compositeWidget, 0, SWT.CENTER);");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("compositeWidget.removeSelectionListener(nameListener);");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("compositeWidget.setItems(getEnumerationFeatureValues());");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("compositeWidget.setText(getFeatureAsText());");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("compositeWidget.addSelectionListener(nameListener);");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("//        value = ( bc.isComposite() ? \"true\" : \"false\" );");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("/**");
    ...
    _builder.newLine();
    _builder.append("            ");
    _builder.append("return (bc.isComposite() ? \"true\" : \"false\");");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("int index = compositeWidget.getSelectionIndex();");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("boolean newValue = (index == 0 ? false : true);");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("if (newValue != bc.isComposite()) {");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("bc.setComposite(newValue);");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("}");
    _builder.newLine();
