 ...
 * <ul>
 *   <li>{@link org.eclipselabs.spray.shapes.RoundedRectangle#getLayout <em>Layout</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.RoundedRectangle#getShape <em>Shape</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipselabs.spray.shapes.ShapesPackage#getRoundedRectangle()
 * @model
 * @generated
 */
public interface RoundedRectangle extends Shape
{
   ...
   * @see org.eclipselabs.spray.shapes.ShapesPackage#getRoundedRectangle_Layout()
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.spray.shapes.RoundedRectangle#getLayout <em>Layout</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipselabs.spray.shapes.ShapesPackage#getRoundedRectangle_Shape()
   * @model containment="true"
   * @generated
   */
