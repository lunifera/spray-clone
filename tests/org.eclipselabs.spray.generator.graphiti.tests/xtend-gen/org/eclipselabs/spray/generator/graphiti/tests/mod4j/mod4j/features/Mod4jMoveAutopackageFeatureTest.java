...
public class Mod4jMoveAutopackageFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jMoveAutopackageFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jMoveAutopackageFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jMoveAutopackageFeature extends Mod4jMoveAutopackageFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jMoveAutopackageFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
