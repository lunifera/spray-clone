...
public class LWC_PipeConnectionBase extends DefaultSprayConnection {
	...
	public static enum TextIds {
	   ...
	   public LWC_PipeConnectionBase(final IFeatureProvider fp) {
	super(fp);
	}
	...
	protected ConnectionDecorator createDecorator_1(Diagram diagram, Connection connection, ISprayStyle sprayStyle) {
		...
		element.setValue("");
		peService.setPropertyValue(element, ISprayConstants.TEXT_ID, TextIds.pipeText.name());
