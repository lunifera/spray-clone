...
import org.eclipselabs.spray.examples.mod4j.styles.BusmodDefaultStyle;
...
public class BusinessClassStyleBase extends BusmodDefaultStyle {
    ...
    public Style newStyle(Diagram diagram) {
        ...
        style.setId("BusinessClassStyle");
        style.setDescription("The style for the business class.");
