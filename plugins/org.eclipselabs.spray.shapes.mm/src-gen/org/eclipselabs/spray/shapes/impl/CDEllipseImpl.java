 ...
 * <ul>
 *   <li>{@link org.eclipselabs.spray.shapes.impl.CDEllipseImpl#getLayout <em>Layout</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CDEllipseImpl extends ShapeConnectionImpl implements CDEllipse
{
  ...
  {
    return ShapesPackage.Literals.CD_ELLIPSE;
  }
  ...
  public NotificationChain basicSetLayout(RectangleEllipseLayout newLayout, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ShapesPackage.CD_ELLIPSE__LAYOUT, oldLayout, newLayout);
  ...
  public void setLayout(RectangleEllipseLayout newLayout)
  {
    if (newLayout != layout)
    {
      ...
      if (layout != null)
        msgs = ((InternalEObject)layout).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ShapesPackage.CD_ELLIPSE__LAYOUT, null, msgs);
      if (newLayout != null)
        msgs = ((InternalEObject)newLayout).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ShapesPackage.CD_ELLIPSE__LAYOUT, null, msgs);
      msgs = basicSetLayout(newLayout, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapesPackage.CD_ELLIPSE__LAYOUT, newLayout, newLayout));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ShapesPackage.CD_ELLIPSE__LAYOUT:
