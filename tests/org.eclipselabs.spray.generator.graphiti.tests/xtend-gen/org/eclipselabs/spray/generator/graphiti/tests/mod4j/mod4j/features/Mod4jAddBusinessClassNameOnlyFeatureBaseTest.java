...
public class Mod4jAddBusinessClassNameOnlyFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jAddBusinessClassNameOnlyFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jAddBusinessClassNameOnlyFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.append("public abstract class Mod4jAddBusinessClassNameOnlyFeatureBase extends AbstractAddFeature {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected final static String typeOrAliasName = \"BusinessClassNameOnly\";");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jAddBusinessClassNameOnlyFeatureBase(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("if (newObject instanceof BusinessClass) {");
    _builder.newLine();
    _builder.append("            ");
    ...
    _builder.newLine();
    _builder.append("                ");
    _builder.append("// cls samplepackage.Package refers to this metaClass»");
    _builder.newLine();
    _builder.append("                ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("final BusinessClass addedModelElement = (BusinessClass) context.getNewObject();");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("// NEW stuff");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("peService.setPropertyValue(conShape , PROPERTY_ALIAS, \"BusinessClassNameOnly\");");
    _builder.newLine();
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected void linkShapes(ContainerShape conShape, BusinessClass addedModelElement) {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("link(conShape, addedModelElement);");
    _builder.newLine();
