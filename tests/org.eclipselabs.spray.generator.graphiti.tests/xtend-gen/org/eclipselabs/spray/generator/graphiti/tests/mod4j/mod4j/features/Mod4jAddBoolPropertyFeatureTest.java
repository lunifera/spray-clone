...
public class Mod4jAddBoolPropertyFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jAddBoolPropertyFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jAddBoolPropertyFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jAddBoolPropertyFeature extends Mod4jAddBoolPropertyFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jAddBoolPropertyFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
