...
public class LWC_Location_NoLineShapeBase extends DefaultSprayShape {
    ...
    public LWC_Location_NoLineShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "LWC_Location_NoLine.containerShape");
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_2, "LWC_Location_NoLine.shape_2");
        ...
        gaService.setLocationAndSize(element_2, 0, 5, 50, 20);
        SprayLayoutService.setLayoutData(shape_2, 50, 20, true);
    ...
    protected Shape createElement_3(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_3, "LWC_Location_NoLine.shape_3");
        ...
        gaService.setLocationAndSize(element_3, 0, 30, 50, 20);
        ...
        peService.setPropertyValue(element_3, ISprayConstants.TEXT_ID, TextIds.valueName.name());
        peService.setPropertyValue(shape_3, ISprayConstants.TEXT_ID, TextIds.valueName.name());
        element_3.setValue("");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "LWC_Location_NoLine.shape_1");
