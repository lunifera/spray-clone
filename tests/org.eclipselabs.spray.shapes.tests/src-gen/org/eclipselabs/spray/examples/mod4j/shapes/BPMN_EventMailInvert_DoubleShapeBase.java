...
public class BPMN_EventMailInvert_DoubleShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public BPMN_EventMailInvert_DoubleShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "BPMN_EventMailInvert_Double.containerShape");
    ...
    protected Shape createElement_3(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_3.add(gaService.createPoint(8, 12, 0, 0));
        pointList_3.add(gaService.createPoint(38, 12, 0, 0));
        pointList_3.add(gaService.createPoint(23, 22, 0, 0));
        ContainerShape shape_3 = peCreateService.createContainerShape(parentShape, false);
        SprayLayoutService.setId(shape_3, "BPMN_EventMailInvert_Double.shape_3");
        ...
        element_3.setForeground(gaService.manageColor(diagram,IColorConstant.WHITE));
    ...
    protected Shape createElement_4(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_4.add(gaService.createPoint(8, 15, 0, 0));
        pointList_4.add(gaService.createPoint(8, 33, 0, 0));
        pointList_4.add(gaService.createPoint(38, 33, 0, 0));
        pointList_4.add(gaService.createPoint(38, 15, 0, 0));
        pointList_4.add(gaService.createPoint(23, 25, 0, 0));
        ContainerShape shape_4 = peCreateService.createContainerShape(parentShape, false);
        SprayLayoutService.setId(shape_4, "BPMN_EventMailInvert_Double.shape_4");
        ...
        element_4.setBackground(gaService.manageColor(diagram,IColorConstant.BLACK));
        element_4.setForeground(gaService.manageColor(diagram,IColorConstant.WHITE));
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_2, "BPMN_EventMailInvert_Double.shape_2");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "BPMN_EventMailInvert_Double.shape_1");
