...
public class SimpleClassShapeShapeBase extends DefaultSprayShape {
    ...
    public SimpleClassShapeShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "SimpleClassShape.containerShape");
    ...
    protected void createCascadedElements(Diagram diagram, ContainerShape containerShape, ISprayStyle sprayStyle) {
        ...
        gaService.setLocationAndSize(element_0, 0, 0, 100, 220);
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_2, "SimpleClassShape.shape_2");
    ...
    protected Shape createElement_3(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_3, "SimpleClassShape.shape_3");
        SprayLayoutService.setCompartment(shape_3, true);
        GraphitiProperties.set(shape_3, ISprayConstants.TEXT_ID, "simpleAttributes");
        SprayLayoutType layout_3 = SprayLayoutType.VERTICAL;
        SprayLayoutService.setLayoutManager(shape_3, layout_3, 20, 20, false);
        SprayLayoutService.setLayoutData(shape_3, 90, 180);
        ...
        gaService.setLocationAndSize(element_3, 5, 30, 90, 180);
        SprayLayoutService.setLayoutData(shape_3, 90, 180, true);
        return shape_3;
    }
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "SimpleClassShape.shape_1");
        RoundedRectangle element_1 = gaService.createPlainRoundedRectangle(shape_1, 5, 5);
        ISprayStyle style_1 = new org.eclipselabs.spray.runtime.graphiti.styles.DefaultSprayStyle();
        element_1.setStyle(style_1.getStyle(diagram));
        gaService.setLocationAndSize(element_1, 0, 0, 100, 220);
        SprayLayoutService.setLayoutData(shape_1, 100, 220, true);
