...
public class Mod4jLayoutBBBFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jLayoutBBBFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jLayoutBBBFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class Mod4jLayoutBBBFeatureBase extends AbstractLayoutFeature {");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jLayoutBBBFeatureBase(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
