...
entryRuleStyleContainer 
:
{ before(grammarAccess.getStyleContainerRule()); }
	 ruleStyleContainer
{ after(grammarAccess.getStyleContainerRule()); } 
	 EOF 
;
...
ruleStyleContainer
	...
	:
(
{ before(grammarAccess.getStyleContainerAccess().getStyleContainerElementAssignment()); }
(rule__StyleContainer__StyleContainerElementAssignment)*
{ after(grammarAccess.getStyleContainerAccess().getStyleContainerElementAssignment()); }
)
...
:
(
{ before(grammarAccess.getStyleContainerAccess().getStyleContainerElementStyleContainerElementParserRuleCall_0()); }
	ruleStyleContainerElement{ after(grammarAccess.getStyleContainerAccess().getStyleContainerElementStyleContainerElementParserRuleCall_0()); }
)
