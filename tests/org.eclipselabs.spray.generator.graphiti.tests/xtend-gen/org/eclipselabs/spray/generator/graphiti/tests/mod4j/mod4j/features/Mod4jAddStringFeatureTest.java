...
public class Mod4jAddStringFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jAddStringFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jAddStringFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jAddStringFeature extends Mod4jAddStringFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jAddStringFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
