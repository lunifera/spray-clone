...
public class StringPropertyDefaultValueSectionBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type StringPropertyDefaultValueSectionBaseTest"
      + "\nThe method assertEquals is undefined for the type StringPropertyDefaultValueSectionBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class StringPropertyDefaultValueSectionBase extends GFPropertySection implements ITabbedPropertyConstants {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected Text           defaultValueWidget;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("/**");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("defaultValueWidget = factory.createText(composite, \"\");");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("defaultValueWidget.removeModifyListener(nameListener);");
    _builder.newLine();
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("            ");
    _builder.append("value = bc.getDefaultValue();");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("defaultValueWidget.setText(value == null ? \"\" : value);");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("defaultValueWidget.addModifyListener(nameListener);");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("String newValue = defaultValueWidget.getText();");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("if (!newValue.equals(bc.getDefaultValue())) {");
    _builder.newLine();
    _builder.append("            ");
