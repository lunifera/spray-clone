...
public class PolylineTestShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public PolylineTestShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "PolylineTest.containerShape");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_1.add(gaService.createPoint(10, 10, 0, 0));
        pointList_1.add(gaService.createPoint(0, 10, 0, 0));
        ContainerShape shape_1 = peCreateService.createContainerShape(parentShape, false);
        SprayLayoutService.setId(shape_1, "PolylineTest.shape_1");
