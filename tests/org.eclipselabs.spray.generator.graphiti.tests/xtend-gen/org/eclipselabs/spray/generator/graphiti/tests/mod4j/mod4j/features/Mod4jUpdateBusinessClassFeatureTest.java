...
public class Mod4jUpdateBusinessClassFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jUpdateBusinessClassFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jUpdateBusinessClassFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jUpdateBusinessClassFeature extends Mod4jUpdateBusinessClassFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jUpdateBusinessClassFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
