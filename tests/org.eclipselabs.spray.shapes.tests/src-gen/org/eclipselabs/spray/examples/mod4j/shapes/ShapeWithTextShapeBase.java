...
public class ShapeWithTextShapeBase extends DefaultSprayShape {
    ...
    public ShapeWithTextShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "ShapeWithText.containerShape");
    ...
    protected void createCascadedElements(Diagram diagram, ContainerShape containerShape, ISprayStyle sprayStyle) {
        ...
        gaService.setLocationAndSize(element_0, 0, 0, 100, 200);
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_2, "ShapeWithText.shape_2");
        ...
        gaService.setLocationAndSize(element_2, 0, 30, 100, 30);
        SprayLayoutService.setLayoutData(shape_2, 100, 30, true);
    ...
    protected Shape createElement_3(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_3, "ShapeWithText.shape_3");
        ...
        gaService.setLocationAndSize(element_3, 0, 30, 100, 30);
        SprayLayoutService.setLayoutData(shape_3, 100, 30, true);
        element_3.setHorizontalAlignment(Orientation.ALIGNMENT_LEFT);
        element_3.setVerticalAlignment(Orientation.ALIGNMENT_TOP);
        peService.setPropertyValue(element_3, ISprayConstants.TEXT_ID, TextIds.text2.name());
        peService.setPropertyValue(shape_3, ISprayConstants.TEXT_ID, TextIds.text2.name());
        element_3.setValue("");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "ShapeWithText.shape_1");
        ...
        gaService.setLocationAndSize(element_1, 0, 0, 100, 200);
        SprayLayoutService.setLayoutData(shape_1, 100, 200, true);
