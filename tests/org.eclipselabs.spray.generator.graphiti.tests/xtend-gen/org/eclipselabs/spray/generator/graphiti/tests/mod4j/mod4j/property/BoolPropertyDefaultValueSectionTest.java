...
public class BoolPropertyDefaultValueSectionTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type BoolPropertyDefaultValueSectionTest"
      + "\nThe method assertEquals is undefined for the type BoolPropertyDefaultValueSectionTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class BoolPropertyDefaultValueSection extends BoolPropertyDefaultValueSectionBase {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
