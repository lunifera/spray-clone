...
public class Mod4jDirectEditStringFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jDirectEditStringFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jDirectEditStringFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class Mod4jDirectEditStringFeatureBase extends AbstractDirectEditingFeature {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jDirectEditStringFeatureBase(IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
