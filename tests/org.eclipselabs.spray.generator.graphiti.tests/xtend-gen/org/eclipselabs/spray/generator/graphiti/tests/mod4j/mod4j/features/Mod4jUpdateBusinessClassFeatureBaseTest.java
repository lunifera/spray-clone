...
public class Mod4jUpdateBusinessClassFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jUpdateBusinessClassFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jUpdateBusinessClassFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class Mod4jUpdateBusinessClassFeatureBase extends AbstractUpdateFeature {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jUpdateBusinessClassFeatureBase(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
