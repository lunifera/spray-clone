...
public class GreenToOrangeBase extends PredefinedColoredAreas implements ISprayGradient {
     ...
     */
     public GradientColoredAreas getGradientColoredAreas( ) {
         ...
         addGradientColoredArea(gcas,"00FF00",0,org.eclipse.graphiti.mm.algorithms.styles.LocationType.LOCATION_TYPE_RELATIVE, "FF9933",100,org.eclipse.graphiti.mm.algorithms.styles.LocationType.LOCATION_TYPE_RELATIVE);
