...
public class BPMN_EventParallel_defaultShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public BPMN_EventParallel_defaultShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "BPMN_EventParallel_default.containerShape");
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_2.add(gaService.createPoint(20, 5, 0, 0));
        pointList_2.add(gaService.createPoint(30, 5, 0, 0));
        pointList_2.add(gaService.createPoint(30, 20, 0, 0));
        pointList_2.add(gaService.createPoint(45, 20, 0, 0));
        pointList_2.add(gaService.createPoint(45, 30, 0, 0));
        pointList_2.add(gaService.createPoint(30, 30, 0, 0));
        pointList_2.add(gaService.createPoint(30, 45, 0, 0));
        pointList_2.add(gaService.createPoint(20, 45, 0, 0));
        pointList_2.add(gaService.createPoint(20, 30, 0, 0));
        pointList_2.add(gaService.createPoint(5, 30, 0, 0));
        pointList_2.add(gaService.createPoint(5, 20, 0, 0));
        pointList_2.add(gaService.createPoint(20, 20, 0, 0));
        ContainerShape shape_2 = peCreateService.createContainerShape(parentShape, false);
        SprayLayoutService.setId(shape_2, "BPMN_EventParallel_default.shape_2");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "BPMN_EventParallel_default.shape_1");
