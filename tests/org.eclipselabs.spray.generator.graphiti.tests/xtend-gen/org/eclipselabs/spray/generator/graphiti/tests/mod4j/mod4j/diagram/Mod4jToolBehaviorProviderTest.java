...
public class Mod4jToolBehaviorProviderTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jToolBehaviorProviderTest"
      + "\nThe method assertEquals is undefined for the type Mod4jToolBehaviorProviderTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jToolBehaviorProvider extends Mod4jToolBehaviorProviderBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jToolBehaviorProvider(final IDiagramTypeProvider dtp) {");
    _builder.newLine();
    _builder.append("        ");
