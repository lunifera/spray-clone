...
public class MydiagramDefaultStyleBase extends org.eclipselabs.spray.runtime.graphiti.styles.DefaultSprayStyle {
    ...
    public Style newStyle(Diagram diagram) {
        ...
        style.setId("MydiagramDefaultStyle");
        style.setDescription("The default style of the mydiagram diagram type.");
