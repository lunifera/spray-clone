...
public class Mod4jMovePackageFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jMovePackageFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jMovePackageFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class Mod4jMovePackageFeatureBase extends DefaultMoveShapeFeature {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jMovePackageFeatureBase(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
