...
public class A1ShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public A1ShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "A1.containerShape");
        
        // define general layout for ContainerShape
        sprayStyle = new org.eclipselabs.spray.examples.mod4j.styles.B1();
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "A1.shape_1");
