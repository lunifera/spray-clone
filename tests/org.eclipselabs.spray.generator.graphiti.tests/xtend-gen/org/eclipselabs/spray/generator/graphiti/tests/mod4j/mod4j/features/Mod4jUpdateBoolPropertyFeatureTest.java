...
public class Mod4jUpdateBoolPropertyFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jUpdateBoolPropertyFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jUpdateBoolPropertyFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jUpdateBoolPropertyFeature extends Mod4jUpdateBoolPropertyFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jUpdateBoolPropertyFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
