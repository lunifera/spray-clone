...
public class BoolPropertyNullableSectionTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type BoolPropertyNullableSectionTest"
      + "\nThe method assertEquals is undefined for the type BoolPropertyNullableSectionTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class BoolPropertyNullableSection extends BoolPropertyNullableSectionBase {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
