...
public class Mod4jCreateBBBFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jCreateBBBFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jCreateBBBFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jCreateBBBFeature extends Mod4jCreateBBBFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jCreateBBBFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
