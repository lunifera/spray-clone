...
public class CenterAnchorsTestShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public CenterAnchorsTestShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "CenterAnchorsTest.containerShape");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "CenterAnchorsTest.shape_1");
