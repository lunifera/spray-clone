...
public class NestedShapesTestShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public NestedShapesTestShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "NestedShapesTest.containerShape");
    ...
    protected Shape createElement_4(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_4, "NestedShapesTest.shape_4");
        SprayLayoutService.setCompartment(shape_4, false);
        
        Ellipse element_4 = gaService.createPlainEllipse(shape_4);
        ISprayStyle style_4 = sprayStyle;
        element_4.setStyle(style_4.getStyle(diagram));
        gaService.setLocationAndSize(element_4, 0, 0, 20, 20);
        SprayLayoutService.setLayoutData(shape_4, 20, 20, true);
        return shape_4;
    }
    protected Shape createElement_3(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_3.add(gaService.createPoint(0, 50, 0, 0));
        pointList_3.add(gaService.createPoint(50, 0, 0, 0));
        ...
        SprayLayoutService.setId(shape_3, "NestedShapesTest.shape_3");
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_2, "NestedShapesTest.shape_2");
        ...
        gaService.setLocationAndSize(element_2, 0, 0, 100, 100);
        SprayLayoutService.setLayoutData(shape_2, 100, 100, true);
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "NestedShapesTest.shape_1");
