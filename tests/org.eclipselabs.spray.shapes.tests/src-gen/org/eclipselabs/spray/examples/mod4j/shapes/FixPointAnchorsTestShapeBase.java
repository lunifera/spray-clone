...
public class FixPointAnchorsTestShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public FixPointAnchorsTestShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "FixPointAnchorsTest.containerShape");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "FixPointAnchorsTest.shape_1");
