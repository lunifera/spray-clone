...
public class BPMN_EventCancel_BoldInvertShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public BPMN_EventCancel_BoldInvertShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "BPMN_EventCancel_BoldInvert.containerShape");
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_2.add(gaService.createPoint(15, 10, 0, 0));
        pointList_2.add(gaService.createPoint(25, 20, 0, 0));
        pointList_2.add(gaService.createPoint(35, 10, 0, 0));
        pointList_2.add(gaService.createPoint(40, 15, 0, 0));
        pointList_2.add(gaService.createPoint(30, 25, 0, 0));
        pointList_2.add(gaService.createPoint(40, 35, 0, 0));
        pointList_2.add(gaService.createPoint(35, 40, 0, 0));
        pointList_2.add(gaService.createPoint(25, 30, 0, 0));
        pointList_2.add(gaService.createPoint(15, 40, 0, 0));
        pointList_2.add(gaService.createPoint(10, 35, 0, 0));
        pointList_2.add(gaService.createPoint(20, 25, 0, 0));
        ...
        SprayLayoutService.setId(shape_2, "BPMN_EventCancel_BoldInvert.shape_2");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "BPMN_EventCancel_BoldInvert.shape_1");
