...
public class ClassShapeShapeBase extends DefaultSprayShape {
    ...
    protected void createCascadedElements(Diagram diagram, ContainerShape containerShape, ISprayStyle sprayStyle) {
        ...
        gaService.setLocationAndSize(element_0, 0, 0, 100, 420);
    ...
    protected Shape createElement_4(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setLayoutManager(shape_4, layout_4, 5, 10, false);
        SprayLayoutService.setLayoutData(shape_4, 95, 196);
        SprayLayoutService.getLayoutData(shape_4).setHorizontalStrechable(false);
        ...
        gaService.setLocationAndSize(element_4, 0, 22, 95, 196);
        SprayLayoutService.setLayoutData(shape_4, 95, 196, true);
    ...
    protected Shape createElement_5(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_5.add(gaService.createPoint(0, 220, 0, 0));
        pointList_5.add(gaService.createPoint(100, 220, 0, 0));
    ...
    protected Shape createElement_6(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setLayoutManager(shape_6, layout_6, 0, 0, false);
        SprayLayoutService.setLayoutData(shape_6, 95, 196);
        ...
        gaService.setLocationAndSize(element_6, 0, 222, 95, 196);
        SprayLayoutService.setLayoutData(shape_6, 95, 196, true);
        return shape_6;
    }
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        gaService.setLocationAndSize(element_1, 0, 0, 100, 420);
        SprayLayoutService.setLayoutData(shape_1, 100, 420, true);
