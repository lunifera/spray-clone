...
public class Mod4jAddBBBFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jAddBBBFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jAddBBBFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jAddBBBFeature extends Mod4jAddBBBFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jAddBBBFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
