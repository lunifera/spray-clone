...
public class BPMN_EventCancel_DoubleShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public BPMN_EventCancel_DoubleShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "BPMN_EventCancel_Double.containerShape");
    ...
    protected Shape createElement_3(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_3.add(gaService.createPoint(13, 8, 0, 0));
        pointList_3.add(gaService.createPoint(23, 18, 0, 0));
        pointList_3.add(gaService.createPoint(33, 8, 0, 0));
        pointList_3.add(gaService.createPoint(38, 13, 0, 0));
        pointList_3.add(gaService.createPoint(28, 23, 0, 0));
        pointList_3.add(gaService.createPoint(38, 33, 0, 0));
        pointList_3.add(gaService.createPoint(33, 38, 0, 0));
        pointList_3.add(gaService.createPoint(23, 28, 0, 0));
        pointList_3.add(gaService.createPoint(13, 38, 0, 0));
        pointList_3.add(gaService.createPoint(8, 33, 0, 0));
        pointList_3.add(gaService.createPoint(18, 23, 0, 0));
        pointList_3.add(gaService.createPoint(8, 13, 0, 0));
        ContainerShape shape_3 = peCreateService.createContainerShape(parentShape, false);
        SprayLayoutService.setId(shape_3, "BPMN_EventCancel_Double.shape_3");
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_2, "BPMN_EventCancel_Double.shape_2");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "BPMN_EventCancel_Double.shape_1");
