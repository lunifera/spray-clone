 ...
 * <ul>
 *   <li>{@link org.eclipselabs.spray.shapes.impl.PolylineImpl#getLayout <em>Layout</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PolylineImpl extends ShapeImpl implements Polyline
{
  ...
  {
    return ShapesPackage.Literals.POLYLINE;
  }
  ...
  public NotificationChain basicSetLayout(PolyLineLayout newLayout, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ShapesPackage.POLYLINE__LAYOUT, oldLayout, newLayout);
  ...
  public void setLayout(PolyLineLayout newLayout)
  {
    if (newLayout != layout)
    {
      ...
      if (layout != null)
        msgs = ((InternalEObject)layout).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ShapesPackage.POLYLINE__LAYOUT, null, msgs);
      if (newLayout != null)
        msgs = ((InternalEObject)newLayout).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ShapesPackage.POLYLINE__LAYOUT, null, msgs);
      msgs = basicSetLayout(newLayout, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapesPackage.POLYLINE__LAYOUT, newLayout, newLayout));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ShapesPackage.POLYLINE__LAYOUT:
