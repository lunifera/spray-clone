...
public class BPMN_Gateway_AND_EventShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public BPMN_Gateway_AND_EventShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "BPMN_Gateway_AND_Event.containerShape");
    ...
    protected Shape createElement_3(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_3.add(gaService.createPoint(16, 4, 0, 0));
        pointList_3.add(gaService.createPoint(21, 4, 0, 0));
        pointList_3.add(gaService.createPoint(21, 16, 0, 0));
        pointList_3.add(gaService.createPoint(33, 16, 0, 0));
        pointList_3.add(gaService.createPoint(33, 21, 0, 0));
        pointList_3.add(gaService.createPoint(21, 21, 0, 0));
        pointList_3.add(gaService.createPoint(21, 33, 0, 0));
        pointList_3.add(gaService.createPoint(16, 33, 0, 0));
        pointList_3.add(gaService.createPoint(16, 21, 0, 0));
        pointList_3.add(gaService.createPoint(4, 21, 0, 0));
        pointList_3.add(gaService.createPoint(4, 16, 0, 0));
        pointList_3.add(gaService.createPoint(16, 16, 0, 0));
        pointList_3.add(gaService.createPoint(16, 4, 0, 0));
        ContainerShape shape_3 = peCreateService.createContainerShape(parentShape, false);
        SprayLayoutService.setId(shape_3, "BPMN_Gateway_AND_Event.shape_3");
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_2, "BPMN_Gateway_AND_Event.shape_2");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "BPMN_Gateway_AND_Event.shape_1");
