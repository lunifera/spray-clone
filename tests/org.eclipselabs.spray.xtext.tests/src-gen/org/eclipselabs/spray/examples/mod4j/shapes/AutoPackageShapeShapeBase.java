...
public class AutoPackageShapeShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
        classes
    }
    
    public AutoPackageShapeShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "AutoPackageShape.containerShape");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "AutoPackageShape.shape_1");
        ...
        SprayLayoutService.setLayoutManager(shape_1, layout_1, 10, 5, true);
