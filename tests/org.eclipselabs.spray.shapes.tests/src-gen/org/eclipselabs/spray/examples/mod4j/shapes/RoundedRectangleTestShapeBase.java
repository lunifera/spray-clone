...
public class RoundedRectangleTestShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public RoundedRectangleTestShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "RoundedRectangleTest.containerShape");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "RoundedRectangleTest.shape_1");
        RoundedRectangle element_1 = gaService.createPlainRoundedRectangle(shape_1, 5, 100);
