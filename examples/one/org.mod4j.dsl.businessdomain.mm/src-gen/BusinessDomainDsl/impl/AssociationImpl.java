...
public class AssociationImpl extends ModelElementImpl implements Association
{
   ...
   * @ordered
   */
  protected static final Multiplicity TARGET_MULTIPLICITY_EDEFAULT = Multiplicity.ONE;
   ...
   * @generated
   */
  public BusinessDomainModel basicGetModel()
  {
    if (eContainerFeatureID() != BusinessDomainDslPackage.ASSOCIATION__MODEL) return null;
    return (BusinessDomainModel)eInternalContainer();
  }
