...
public class BPMN_Activity_EventSubProcessShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
        shapeName
    }
    
    public BPMN_Activity_EventSubProcessShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "BPMN_Activity_EventSubProcess.containerShape");
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_2, "BPMN_Activity_EventSubProcess.shape_2");
        ...
        gaService.setLocationAndSize(element_2, 5, 30, 110, 20);
        SprayLayoutService.setLayoutData(shape_2, 110, 20, true);
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "BPMN_Activity_EventSubProcess.shape_1");
        ...
        element_1.setLineStyle(LineStyle.DOT);
