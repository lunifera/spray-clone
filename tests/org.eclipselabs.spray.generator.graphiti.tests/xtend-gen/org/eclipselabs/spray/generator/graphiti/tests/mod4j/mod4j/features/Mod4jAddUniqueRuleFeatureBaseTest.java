...
public class Mod4jAddUniqueRuleFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jAddUniqueRuleFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jAddUniqueRuleFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.append("public abstract class Mod4jAddUniqueRuleFeatureBase extends AbstractAddFeature {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected final static String typeOrAliasName = \"UniqueRule\";");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jAddUniqueRuleFeatureBase(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("if (newObject instanceof UniqueRule) {");
    _builder.newLine();
    _builder.append("            ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("final UniqueRule addedModelElement = (UniqueRule) context.getNewObject();");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("// NEW stuff");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected void linkShapes(ContainerShape conShape, UniqueRule addedModelElement) {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("link(conShape, addedModelElement);");
    _builder.newLine();
