...
public class Mod4jCreateBusinessClassNameOnlyFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jCreateBusinessClassNameOnlyFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jCreateBusinessClassNameOnlyFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class Mod4jCreateBusinessClassNameOnlyFeatureBase extends AbstractCreateFeature {");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected BusinessClass newClass = null;");
    _builder.newLine();
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jCreateBusinessClassNameOnlyFeatureBase (final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("// set name and description of the creation feature");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("super(fp, \"BusinessClassNameOnly\", \"Create new BusinessClassNameOnly\");");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("// cls Package refers to this metaClass");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("newClass = createBusinessClassNameOnly(context);");
    _builder.newLine();
    _builder.append("    ");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("//       org.eclipse.emf.ecore.impl.EReferenceImpl@edbf075 (name: types) (ordered: true, unique: true, lowerBound: 0, upperBound: -1) (changeable: true, volatile: false, transient: false, defaultValueLiteral: null, unsettable: false, derived: false) (containment: true, resolveProxies: false) ");
    _builder.newLine();
    _builder.append("            ");
    _builder.newLine();
    _builder.append("            ");
    ...
    _builder.newLine();
    _builder.append("             ");
    _builder.append("* Creates a new {@link BusinessClass} instance and adds it to the containing type.");
    _builder.newLine();
    _builder.append("             ");
    _builder.append("*/");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("protected BusinessClass createBusinessClassNameOnly(final ICreateContext context) {");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("// create BusinessClass instance");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("final BusinessClass newClass = BusinessDomainDslFactory.eINSTANCE.createBusinessClass();");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("// ask user for BusinessClassNameOnly name");
    _builder.newLine();
    _builder.append("                ");
    ...
    _builder.newLine();
    _builder.append("                    ");
    _builder.append("model.getTypes().add(newClass);");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("                       ");
    _builder.append("samplepackage.Package domainObject = (samplepackage.Package) target;");
    _builder.newLine();
    _builder.append("                           ");
    _builder.append("// containment");
    _builder.newLine();
    _builder.append("                           ");
    _builder.append("domainObject.getClasses().add(newClass);");
    _builder.newLine();
    _builder.append("                           ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("ctx.putProperty(PROPERTY_ALIAS, \"BusinessClassNameOnly\");");
    _builder.newLine();
    _builder.append("        ");
