...
public class Mod4jCopyFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jCopyFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jCopyFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jCopyFeature extends Mod4jCopyFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jCopyFeature(IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
