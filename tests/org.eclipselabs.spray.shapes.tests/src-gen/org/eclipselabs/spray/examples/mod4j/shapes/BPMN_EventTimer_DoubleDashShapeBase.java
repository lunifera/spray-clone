...
public class BPMN_EventTimer_DoubleDashShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public BPMN_EventTimer_DoubleDashShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "BPMN_EventTimer_DoubleDash.containerShape");
    ...
    protected Shape createElement_4(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_4.add(gaService.createPoint(32, 19, 0, 0));
        pointList_4.add(gaService.createPoint(19, 19, 0, 0));
        pointList_4.add(gaService.createPoint(22, 3, 0, 0));
        ContainerShape shape_4 = peCreateService.createContainerShape(parentShape, false);
        SprayLayoutService.setId(shape_4, "BPMN_EventTimer_DoubleDash.shape_4");
    ...
    protected Shape createElement_5(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_5.add(gaService.createPoint(19, 0, 0, 0));
        pointList_5.add(gaService.createPoint(19, 4, 0, 0));
        Shape shape_5 = peCreateService.createShape(parentShape, false);
        SprayLayoutService.setId(shape_5, "BPMN_EventTimer_DoubleDash.shape_5");
    ...
    protected Shape createElement_6(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_6.add(gaService.createPoint(19, 38, 0, 0));
        pointList_6.add(gaService.createPoint(19, 34, 0, 0));
        Shape shape_6 = peCreateService.createShape(parentShape, false);
        SprayLayoutService.setId(shape_6, "BPMN_EventTimer_DoubleDash.shape_6");
    ...
    protected Shape createElement_7(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_7.add(gaService.createPoint(0, 19, 0, 0));
        pointList_7.add(gaService.createPoint(4, 19, 0, 0));
        Shape shape_7 = peCreateService.createShape(parentShape, false);
        SprayLayoutService.setId(shape_7, "BPMN_EventTimer_DoubleDash.shape_7");
    ...
    protected Shape createElement_8(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        List<Point> pointList_8 = new ArrayList<Point>();
        pointList_8.add(gaService.createPoint(38, 19, 0, 0));
        pointList_8.add(gaService.createPoint(34, 19, 0, 0));
        Shape shape_8 = peCreateService.createShape(parentShape, false);
        SprayLayoutService.setId(shape_8, "BPMN_EventTimer_DoubleDash.shape_8");
        Polyline element_8 = gaService.createPlainPolyline(shape_8, pointList_8);
        ISprayStyle style_8 = sprayStyle;
        element_8.setStyle(style_8.getStyle(diagram));
        return shape_8;
    }
    protected Shape createElement_3(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_3, "BPMN_EventTimer_DoubleDash.shape_3");
        ...
        gaService.setLocationAndSize(element_3, 4, 4, 38, 38);
        SprayLayoutService.setLayoutData(shape_3, 38, 38, true);
        ...
        createElement_8(diagram, shape_3, style_3);
        return shape_3;
    }
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_2, "BPMN_EventTimer_DoubleDash.shape_2");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "BPMN_EventTimer_DoubleDash.shape_1");
