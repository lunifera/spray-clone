...
public class Mod4jAddPackageFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jAddPackageFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jAddPackageFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.append("public abstract class Mod4jAddPackageFeatureBase extends AbstractAddFeature {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected final static String typeOrAliasName = \"Package\";");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jAddPackageFeatureBase(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
