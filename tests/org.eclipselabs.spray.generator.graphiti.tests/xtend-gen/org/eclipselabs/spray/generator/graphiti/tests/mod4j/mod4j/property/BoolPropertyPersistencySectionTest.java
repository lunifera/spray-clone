...
public class BoolPropertyPersistencySectionTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type BoolPropertyPersistencySectionTest"
      + "\nThe method assertEquals is undefined for the type BoolPropertyPersistencySectionTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class BoolPropertyPersistencySection extends BoolPropertyPersistencySectionBase {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
