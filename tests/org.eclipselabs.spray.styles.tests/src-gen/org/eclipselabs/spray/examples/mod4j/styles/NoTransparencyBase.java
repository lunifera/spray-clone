...
/**
 * This is a generated Style class for Spray.
 * Description: This is a description for the NoTransparency
 */
@SuppressWarnings("all")
public class NoTransparencyBase extends org.eclipselabs.spray.runtime.graphiti.styles.DefaultSprayStyle {
    ...
    public Style newStyle(Diagram diagram) {
        ...
        style.setId("NoTransparency");
        style.setDescription("This is a description for the NoTransparency");
    ...
    protected void defineLineAttributes(Diagram diagram, Style style) {
        ...
        style.setForeground(gaService.manageColor(diagram, new ColorConstant(23, 45, 56)));
