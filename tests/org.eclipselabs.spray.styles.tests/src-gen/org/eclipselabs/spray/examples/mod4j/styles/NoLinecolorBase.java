...
/**
 * This is a generated Style class for Spray.
 * Description: This is a description for the NoLinecolor
 */
@SuppressWarnings("all")
public class NoLinecolorBase extends org.eclipselabs.spray.runtime.graphiti.styles.DefaultSprayStyle {
    ...
    public Style newStyle(Diagram diagram) {
        ...
        style.setId("NoLinecolor");
        style.setDescription("This is a description for the NoLinecolor");
    ...
    protected void defineBackground(Diagram diagram, Style style) {
        ...
        style.setBackground(gaService.manageColor(diagram, new ColorConstant(45, 23, 237)));
    }
    ...
    public Color getFontColor(Diagram diagram) {
        ...
        return gaService.manageColor(diagram, IColorConstant.LIGHT_BLUE);
    }
