...
public class Mod4jLayoutBBBFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jLayoutBBBFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jLayoutBBBFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jLayoutBBBFeature extends Mod4jLayoutBBBFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jLayoutBBBFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
