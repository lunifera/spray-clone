...
public class Mod4jAddSimpleClassFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jAddSimpleClassFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jAddSimpleClassFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.append("public abstract class Mod4jAddSimpleClassFeatureBase extends AbstractAddFeature {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected final static String typeOrAliasName = \"SimpleClass\";");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jAddSimpleClassFeatureBase(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("peService.setPropertyValue(conShape , PROPERTY_ALIAS, \"SimpleClass\");");
    _builder.newLine();
    _builder.newLine();
    _builder.append("        ");
