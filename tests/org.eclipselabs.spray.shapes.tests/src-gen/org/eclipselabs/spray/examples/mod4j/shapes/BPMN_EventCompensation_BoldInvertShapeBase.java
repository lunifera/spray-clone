...
public class BPMN_EventCompensation_BoldInvertShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public BPMN_EventCompensation_BoldInvertShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "BPMN_EventCompensation_BoldInvert.containerShape");
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_2.add(gaService.createPoint(22, 15, 0, 0));
        pointList_2.add(gaService.createPoint(22, 35, 0, 0));
        pointList_2.add(gaService.createPoint(7, 25, 0, 0));
        ContainerShape shape_2 = peCreateService.createContainerShape(parentShape, false);
        SprayLayoutService.setId(shape_2, "BPMN_EventCompensation_BoldInvert.shape_2");
    ...
    protected Shape createElement_3(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_3.add(gaService.createPoint(22, 25, 0, 0));
        pointList_3.add(gaService.createPoint(37, 15, 0, 0));
        pointList_3.add(gaService.createPoint(37, 35, 0, 0));
        ContainerShape shape_3 = peCreateService.createContainerShape(parentShape, false);
        SprayLayoutService.setId(shape_3, "BPMN_EventCompensation_BoldInvert.shape_3");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "BPMN_EventCompensation_BoldInvert.shape_1");
