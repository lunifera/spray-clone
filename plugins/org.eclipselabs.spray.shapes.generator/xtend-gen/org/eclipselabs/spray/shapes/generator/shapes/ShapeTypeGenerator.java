...
public class ShapeTypeGenerator {
  ...
  public String styleForElement(final ShapeStyleRef s, final String styleName) {
    ...
    if (_notEquals) {
      JvmTypeReference _javaStyle = s.getJavaStyle();
      boolean _notEquals_1 = (!Objects.equal(_javaStyle, null));
      if (_notEquals_1) {
        StringConcatenation _builder = new StringConcatenation();
        _builder.append("new ");
        JvmTypeReference _javaStyle_1 = s.getJavaStyle();
        String _qualifiedName = _javaStyle_1.getQualifiedName();
        _builder.append(_qualifiedName, "");
        _builder.append("()");
        return _builder.toString();
      } else {
        Style _dslStyle = s.getDslStyle();
        boolean _notEquals_2 = (!Objects.equal(_dslStyle, null));
        if (_notEquals_2) {
          StringConcatenation _builder_1 = new StringConcatenation();
          _builder_1.append("new ");
          String _stylesPackage = ProjectProperties.getStylesPackage();
          _builder_1.append(_stylesPackage, "");
          _builder_1.append(".");
          Style _dslStyle_1 = s.getDslStyle();
          String _name = _dslStyle_1.getName();
