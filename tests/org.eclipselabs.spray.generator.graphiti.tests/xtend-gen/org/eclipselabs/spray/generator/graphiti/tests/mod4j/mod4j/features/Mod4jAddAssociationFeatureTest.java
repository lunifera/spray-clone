...
public class Mod4jAddAssociationFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jAddAssociationFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jAddAssociationFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jAddAssociationFeature extends Mod4jAddAssociationFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jAddAssociationFeature(IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
