...
public class Mod4jFeatureProviderTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jFeatureProviderTest"
      + "\nThe method assertEquals is undefined for the type Mod4jFeatureProviderTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jFeatureProvider extends Mod4jFeatureProviderBase {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jFeatureProvider(final IDiagramTypeProvider dtp) {");
    _builder.newLine();
    _builder.append("        ");
