...
public class Mod4jCreatePackageFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jCreatePackageFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jCreatePackageFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class Mod4jCreatePackageFeatureBase extends AbstractCreateFeature {");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jCreatePackageFeatureBase (final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("// set name and description of the creation feature");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("super(fp, \"Package\", \"Create new Package\");");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("newClass = createPackage(context);");
    _builder.newLine();
    _builder.append("    ");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("            ");
    _builder.append("protected samplepackage.Package createPackage(final ICreateContext context) {");
    _builder.newLine();
    _builder.append("                ");
    ...
    _builder.newLine();
    _builder.append("                ");
    _builder.append("// ask user for Package name");
    _builder.newLine();
    _builder.append("                ");
