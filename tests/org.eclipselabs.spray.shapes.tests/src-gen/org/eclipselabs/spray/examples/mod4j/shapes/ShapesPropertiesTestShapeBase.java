...
public class ShapesPropertiesTestShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public ShapesPropertiesTestShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "ShapesPropertiesTest.containerShape");
        
        // define general layout for ContainerShape
        sprayStyle.getStyle(diagram).setProportional(true);
        sprayStyle.getStyle(diagram).setStretchH(true);
        SprayLayoutService.getLayoutData(containerShape).setHorizontalStrechable(true);
    ...
    protected void createCascadedElements(Diagram diagram, ContainerShape containerShape, ISprayStyle sprayStyle) {
        ...
        gaService.setLocationAndSize(element_0, 0, 0, 10, 10);
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "ShapesPropertiesTest.shape_1");
        ...
        gaService.setLocationAndSize(element_1, 0, 0, 10, 10);
        SprayLayoutService.setLayoutData(shape_1, 10, 10, true);
        return shape_1;
    }
    ...
    public SprayLayoutManager getShapeLayout() {
        ...
        layoutManager.setMinSizeWidth(200);
        layoutManager.setMaxSizeWidth(500);
        layoutManager.setMinSizeHeight(200);
        layoutManager.setMaxSizeHeight(500);
