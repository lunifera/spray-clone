...
public class StringPropertyPersistencySectionTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type StringPropertyPersistencySectionTest"
      + "\nThe method assertEquals is undefined for the type StringPropertyPersistencySectionTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class StringPropertyPersistencySection extends StringPropertyPersistencySectionBase {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
