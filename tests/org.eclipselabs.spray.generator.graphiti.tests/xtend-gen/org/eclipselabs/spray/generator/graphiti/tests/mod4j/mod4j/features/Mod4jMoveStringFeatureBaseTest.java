...
public class Mod4jMoveStringFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jMoveStringFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jMoveStringFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class Mod4jMoveStringFeatureBase extends DefaultMoveShapeFeature {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jMoveStringFeatureBase(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
