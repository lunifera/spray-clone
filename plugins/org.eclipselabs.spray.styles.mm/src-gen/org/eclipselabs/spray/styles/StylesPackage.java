 ...
 * @model kind="package"
 *        annotation="http://www.eclipse.org/emf/2002/GenModel modelDirectory='/org.eclipselabs.spray.styles.mm/src-gen' forceOverwrite='true' modelName='Style' updateClasspath='false' importerID='org.eclipse.emf.importer.ecore' complianceLevel='5.0' runtimeVersion='2.8' basePackage='org.eclipselabs.spray'"
 * @generated
 */
public interface StylesPackage extends EPackage
{
  ...
  /**
   * The number of operations of the '<em>Style Container</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int STYLE_CONTAINER_OPERATION_COUNT = 0;
  ...
  /**
   * The number of operations of the '<em>Style Container Element</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int STYLE_CONTAINER_ELEMENT_OPERATION_COUNT = 0;
   ...
   * @ordered
   */
  int STYLE_OPERATION_COUNT = STYLE_CONTAINER_ELEMENT_OPERATION_COUNT + 0;
   ...
   * @ordered
   */
  int GRADIENT_OPERATION_COUNT = STYLE_CONTAINER_ELEMENT_OPERATION_COUNT + 0;
  ...
  /**
   * The number of operations of the '<em>Style Layout</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int STYLE_LAYOUT_OPERATION_COUNT = 0;
  ...
  /**
   * The number of operations of the '<em>Gradient Layout</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int GRADIENT_LAYOUT_OPERATION_COUNT = 0;
  ...
  /**
   * The number of operations of the '<em>Highlighting Values</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int HIGHLIGHTING_VALUES_OPERATION_COUNT = 0;
  ...
  /**
   * The number of operations of the '<em>Gradient Color Area</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int GRADIENT_COLOR_AREA_OPERATION_COUNT = 0;
  ...
  /**
   * The number of operations of the '<em>Color Or Gradient</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int COLOR_OR_GRADIENT_OPERATION_COUNT = 0;
  ...
  /**
   * The number of operations of the '<em>Color With Transparency</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int COLOR_WITH_TRANSPARENCY_OPERATION_COUNT = 0;
   ...
   * @ordered
   */
  int COLOR_OPERATION_COUNT = COLOR_OR_GRADIENT_OPERATION_COUNT + 0;
  ...
  /**
   * The number of operations of the '<em>Gradient Ref</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int GRADIENT_REF_OPERATION_COUNT = COLOR_OR_GRADIENT_OPERATION_COUNT + 0;
  ...
  /**
   * The number of operations of the '<em>Color Constant Ref</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int COLOR_CONSTANT_REF_OPERATION_COUNT = COLOR_OPERATION_COUNT + 0;
  ...
  /**
   * The number of operations of the '<em>Transparent</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int TRANSPARENT_OPERATION_COUNT = COLOR_OR_GRADIENT_OPERATION_COUNT + 0;
