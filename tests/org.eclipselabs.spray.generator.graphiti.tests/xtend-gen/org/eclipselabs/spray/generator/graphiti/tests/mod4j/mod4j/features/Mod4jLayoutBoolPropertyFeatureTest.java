...
public class Mod4jLayoutBoolPropertyFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jLayoutBoolPropertyFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jLayoutBoolPropertyFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jLayoutBoolPropertyFeature extends Mod4jLayoutBoolPropertyFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jLayoutBoolPropertyFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
