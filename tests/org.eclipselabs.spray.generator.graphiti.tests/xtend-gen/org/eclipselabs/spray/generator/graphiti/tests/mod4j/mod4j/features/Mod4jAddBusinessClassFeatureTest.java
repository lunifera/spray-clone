...
public class Mod4jAddBusinessClassFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jAddBusinessClassFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jAddBusinessClassFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jAddBusinessClassFeature extends Mod4jAddBusinessClassFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jAddBusinessClassFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
