...
public class Mod4jLayoutBoolPropertyFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jLayoutBoolPropertyFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jLayoutBoolPropertyFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class Mod4jLayoutBoolPropertyFeatureBase extends AbstractLayoutFeature {");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jLayoutBoolPropertyFeatureBase(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("       ");
    _builder.append("return (businessObjects.size() == 1) && (businessObjects.get(0) instanceof BoolProperty);");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
