...
public class Mod4jDirectEditStringPropertyFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jDirectEditStringPropertyFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jDirectEditStringPropertyFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class Mod4jDirectEditStringPropertyFeatureBase extends AbstractDirectEditingFeature {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jDirectEditStringPropertyFeatureBase(IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("// support direct editing, if it is a StringProperty, and the user clicked");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("// directly on the text and not somewhere else in the rectangle");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("if (bo instanceof StringProperty && ga instanceof AbstractText) {");
    _builder.newLine();
    _builder.append("            ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("// return the initial value of the clicked text on the StringProperty");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("PictogramElement pe = context.getPictogramElement();");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("StringProperty eClass = (StringProperty) getBusinessObjectForPictogramElement(pe);");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("// set the new value on the StringProperty");
    _builder.newLine();
    _builder.append("        ");
