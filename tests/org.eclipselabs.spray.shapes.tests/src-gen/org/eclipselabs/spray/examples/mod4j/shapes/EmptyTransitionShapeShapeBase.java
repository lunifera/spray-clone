...
public class EmptyTransitionShapeShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
        transitionShapeDescription
    }
    
    public EmptyTransitionShapeShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "EmptyTransitionShape.containerShape");
    ...
    protected void createCascadedElements(Diagram diagram, ContainerShape containerShape, ISprayStyle sprayStyle) {
        ...
        gaService.setLocationAndSize(element_0, 0, 0, 20, 75);
        
        
        createElement_1(diagram, containerShape, sprayStyle);
        
        Shape shape_1 = peCreateService.createShape(containerShape, false);
        Text element_1 = gaService.createPlainText(shape_1);
        ISprayStyle style_1 = sprayStyle;
        element_1.setStyle(style_1.getStyle(diagram));
        element_1.setForeground(style_1.getFontColor(diagram));
        gaService.setLocationAndSize(element_1, 0, 75, 20, 20);
        element_1.setHorizontalAlignment(Orientation.ALIGNMENT_LEFT);
        element_1.setVerticalAlignment(Orientation.ALIGNMENT_TOP);
        peService.setPropertyValue(element_1, ISprayConstants.TEXT_ID, TextIds.transitionShapeDescription.name());
        element_1.setValue("");
        directEditingInfo.setPictogramElement(shape_1);
        directEditingInfo.setGraphicsAlgorithm(element_1);
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "EmptyTransitionShape.shape_1");
        SprayLayoutService.setCompartment(shape_1, false);
        Rectangle element_1 = gaService.createPlainRectangle(shape_1);
        ISprayStyle style_1 = sprayStyle;
        element_1.setStyle(style_1.getStyle(diagram));
        gaService.setLocationAndSize(element_1, 0, 0, 20, 75);
        SprayLayoutService.setLayoutData(shape_1, 20, 75, true);
