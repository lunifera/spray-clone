...
public class AssociationTargetMultiplicitySectionTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type AssociationTargetMultiplicitySectionTest"
      + "\nThe method assertEquals is undefined for the type AssociationTargetMultiplicitySectionTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class AssociationTargetMultiplicitySection extends AssociationTargetMultiplicitySectionBase {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
