...
public class ReferencedStyleOnElementTestShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public ReferencedStyleOnElementTestShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "ReferencedStyleOnElementTest.containerShape");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "ReferencedStyleOnElementTest.shape_1");
