...
public class BPMN_EventError_defaultShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public BPMN_EventError_defaultShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "BPMN_EventError_default.containerShape");
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_2, "BPMN_EventError_default.shape_2");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "BPMN_EventError_default.shape_1");
