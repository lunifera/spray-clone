...
public class PackageShapeShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
        classes
    }
    
    public PackageShapeShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "PackageShape.containerShape");
    ...
    protected void createCascadedElements(Diagram diagram, ContainerShape containerShape, ISprayStyle sprayStyle) {
        ...
        gaService.setLocationAndSize(element_0, 0, 0, 200, 200);
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "PackageShape.shape_1");
        SprayLayoutService.setCompartment(shape_1, true);
        GraphitiProperties.set(shape_1, ISprayConstants.TEXT_ID, "classes");
        SprayLayoutType layout_1 = SprayLayoutType.FIXED;
        SprayLayoutService.setLayoutManager(shape_1, layout_1, 0, 0, true);
        SprayLayoutService.setLayoutData(shape_1, 200, 200);
        Rectangle element_1 = gaService.createPlainRectangle(shape_1);
        ISprayStyle style_1 = new org.eclipselabs.spray.examples.mod4j.styles.BusmodDefaultStyle();
        element_1.setStyle(style_1.getStyle(diagram));
        gaService.setLocationAndSize(element_1, 0, 0, 200, 200);
        SprayLayoutService.setLayoutData(shape_1, 200, 200, true);
        return shape_1;
    }
