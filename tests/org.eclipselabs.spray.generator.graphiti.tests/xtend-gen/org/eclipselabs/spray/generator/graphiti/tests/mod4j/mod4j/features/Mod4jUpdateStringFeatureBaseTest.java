...
public class Mod4jUpdateStringFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jUpdateStringFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jUpdateStringFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class Mod4jUpdateStringFeatureBase extends AbstractUpdateFeature {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jUpdateStringFeatureBase(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
