  ...
  protected void _infer(final MetaClass clazz, final IJvmDeclaredTypeAcceptor acceptor, final boolean prelinkingPhase) {
    ...
    final Procedure1<JvmGenericType> _function = new Procedure1<JvmGenericType>() {
      public void apply(final JvmGenericType it) {
        final JvmField field = SprayJvmModelInferrer.this._jvmTypesBuilder.toField(it, "ecoreClass", eClassJvmType);
        EList<JvmMember> _members = it.getMembers();
        SprayJvmModelInferrer.this._jvmTypesBuilder.<JvmField>operator_add(_members, field);
        EList<JvmMember> _members_1 = it.getMembers();
        JvmOperation _getter = SprayJvmModelInferrer.this._jvmTypesBuilder.toGetter(it, "ecoreClass", eClassJvmType);
        SprayJvmModelInferrer.this._jvmTypesBuilder.<JvmOperation>operator_add(_members_1, _getter);
      }
    };
