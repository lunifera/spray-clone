...
import org.eclipselabs.spray.examples.mod4j.styles.MydiagramDefaultStyle;
...
public class UniqueBase extends MydiagramDefaultStyle {
    ...
    protected void defineBackground(Diagram diagram, Style style) {
        ...
        style.setBackground(gaService.manageColor(diagram, IColorConstant.LIGHT_ORANGE));
    }
