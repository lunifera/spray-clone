...
public class Mod4jCustomRedrawFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jCustomRedrawFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jCustomRedrawFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jCustomRedrawFeature extends Mod4jCustomRedrawFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jCustomRedrawFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
