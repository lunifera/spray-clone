...
public class BoolPropertyDefaultValueSectionBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type BoolPropertyDefaultValueSectionBaseTest"
      + "\nThe method assertEquals is undefined for the type BoolPropertyDefaultValueSectionBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class BoolPropertyDefaultValueSectionBase extends GFPropertySection implements ITabbedPropertyConstants {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected BoolProperty bc = null;");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected CCombo       defaultValueWidget;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("/**");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("defaultValueWidget = factory.createCCombo(composite);");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("defaultValueWidget.setLayoutData(data);");
    _builder.newLine();
    _builder.newLine();
    _builder.append("        ");
    _builder.append("CLabel valueLabel = factory.createCLabel(composite, \"DefaultValue\");");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("data = new FormData();");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("data.right = new FormAttachment(defaultValueWidget, -HSPACE);");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("data.top = new FormAttachment(defaultValueWidget, 0, SWT.CENTER);");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("defaultValueWidget.removeSelectionListener(nameListener);");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("defaultValueWidget.setItems(getEnumerationFeatureValues());");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("defaultValueWidget.setText(getFeatureAsText());");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("defaultValueWidget.addSelectionListener(nameListener);");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("//        value = ( bc.isDefaultValue() ? \"true\" : \"false\" );");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("/**");
    ...
    _builder.newLine();
    _builder.append("            ");
    _builder.append("// the filter assured, that it is a BoolProperty");
    _builder.newLine();
    _builder.append("            ");
    ...
    _builder.newLine();
    _builder.append("            ");
    _builder.append("bc = (BoolProperty) bo;");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("return (bc.isDefaultValue() ? \"true\" : \"false\");");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("int index = defaultValueWidget.getSelectionIndex();");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("boolean newValue = (index == 0 ? false : true);");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("if (newValue != bc.isDefaultValue()) {");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("bc.setDefaultValue(newValue);");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("}");
    _builder.newLine();
