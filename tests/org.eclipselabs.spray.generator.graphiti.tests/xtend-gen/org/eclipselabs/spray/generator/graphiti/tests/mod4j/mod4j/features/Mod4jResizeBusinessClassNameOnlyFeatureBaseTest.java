...
public class Mod4jResizeBusinessClassNameOnlyFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jResizeBusinessClassNameOnlyFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jResizeBusinessClassNameOnlyFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class Mod4jResizeBusinessClassNameOnlyFeatureBase extends DefaultResizeShapeFeature {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public Mod4jResizeBusinessClassNameOnlyFeatureBase(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("\t\t");
