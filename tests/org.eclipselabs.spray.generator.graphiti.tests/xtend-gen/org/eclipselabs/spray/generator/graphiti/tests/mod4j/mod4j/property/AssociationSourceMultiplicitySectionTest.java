...
public class AssociationSourceMultiplicitySectionTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type AssociationSourceMultiplicitySectionTest"
      + "\nThe method assertEquals is undefined for the type AssociationSourceMultiplicitySectionTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class AssociationSourceMultiplicitySection extends AssociationSourceMultiplicitySectionBase {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
