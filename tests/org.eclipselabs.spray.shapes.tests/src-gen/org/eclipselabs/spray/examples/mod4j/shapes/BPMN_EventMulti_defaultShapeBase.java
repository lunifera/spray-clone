...
public class BPMN_EventMulti_defaultShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public BPMN_EventMulti_defaultShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "BPMN_EventMulti_default.containerShape");
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_2.add(gaService.createPoint(25, 10, 0, 0));
        pointList_2.add(gaService.createPoint(40, 20, 0, 0));
        pointList_2.add(gaService.createPoint(35, 40, 0, 0));
        pointList_2.add(gaService.createPoint(15, 40, 0, 0));
        pointList_2.add(gaService.createPoint(10, 20, 0, 0));
        ContainerShape shape_2 = peCreateService.createContainerShape(parentShape, false);
        SprayLayoutService.setId(shape_2, "BPMN_EventMulti_default.shape_2");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "BPMN_EventMulti_default.shape_1");
