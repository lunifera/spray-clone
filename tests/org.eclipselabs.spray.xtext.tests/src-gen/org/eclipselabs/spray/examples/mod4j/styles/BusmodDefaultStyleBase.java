...
public class BusmodDefaultStyleBase extends org.eclipselabs.spray.runtime.graphiti.styles.DefaultSprayStyle {
    ...
    public Style newStyle(Diagram diagram) {
        ...
        style.setId("BusmodDefaultStyle");
        style.setDescription("The default style of the bm diagram type.");
