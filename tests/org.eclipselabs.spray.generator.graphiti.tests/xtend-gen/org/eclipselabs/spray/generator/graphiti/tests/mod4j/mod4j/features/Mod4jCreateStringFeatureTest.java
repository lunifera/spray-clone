...
public class Mod4jCreateStringFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jCreateStringFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jCreateStringFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jCreateStringFeature extends Mod4jCreateStringFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jCreateStringFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
