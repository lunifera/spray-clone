...
public class Mod4jResizeBusinessRuleFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jResizeBusinessRuleFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jResizeBusinessRuleFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jResizeBusinessRuleFeature extends Mod4jResizeBusinessRuleFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jResizeBusinessRuleFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
