...
public class Mod4jDirectEditBusinessClassNameOnlyFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jDirectEditBusinessClassNameOnlyFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jDirectEditBusinessClassNameOnlyFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class Mod4jDirectEditBusinessClassNameOnlyFeatureBase extends AbstractDirectEditingFeature {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jDirectEditBusinessClassNameOnlyFeatureBase(IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
