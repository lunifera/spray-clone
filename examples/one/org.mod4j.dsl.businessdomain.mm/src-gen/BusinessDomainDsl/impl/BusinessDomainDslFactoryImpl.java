...
public class BusinessDomainDslFactoryImpl extends EFactoryImpl implements BusinessDomainDslFactory
{
  ...
  public static BusinessDomainDslFactory init()
  {
    try
    {
      BusinessDomainDslFactory theBusinessDomainDslFactory = (BusinessDomainDslFactory)EPackage.Registry.INSTANCE.getEFactory(BusinessDomainDslPackage.eNS_URI);
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case BusinessDomainDslPackage.PACKAGE: return createPackage();
      default:
   ...
   * @generated
   */
  public BusinessDomainDsl.Package createPackage()
  {
