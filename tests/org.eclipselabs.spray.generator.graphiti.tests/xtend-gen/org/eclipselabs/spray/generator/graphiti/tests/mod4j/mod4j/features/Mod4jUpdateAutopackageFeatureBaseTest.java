...
public class Mod4jUpdateAutopackageFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jUpdateAutopackageFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jUpdateAutopackageFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class Mod4jUpdateAutopackageFeatureBase extends AbstractUpdateFeature {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jUpdateAutopackageFeatureBase(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
