...
public class AssociationDescriptionSectionTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type AssociationDescriptionSectionTest"
      + "\nThe method assertEquals is undefined for the type AssociationDescriptionSectionTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class AssociationDescriptionSection extends AssociationDescriptionSectionBase {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
