...
public class PetrinetDefaultStyleBase extends org.eclipselabs.spray.runtime.graphiti.styles.DefaultSprayStyle {
    ...
    public Style newStyle(Diagram diagram) {
        ...
        style.setId("PetrinetDefaultStyle");
        style.setDescription("The default style of the petrinet diagram type.");
