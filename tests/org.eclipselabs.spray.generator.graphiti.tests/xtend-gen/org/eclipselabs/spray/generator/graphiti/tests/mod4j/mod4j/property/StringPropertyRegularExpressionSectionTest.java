...
public class StringPropertyRegularExpressionSectionTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type StringPropertyRegularExpressionSectionTest"
      + "\nThe method assertEquals is undefined for the type StringPropertyRegularExpressionSectionTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class StringPropertyRegularExpressionSection extends StringPropertyRegularExpressionSectionBase {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
