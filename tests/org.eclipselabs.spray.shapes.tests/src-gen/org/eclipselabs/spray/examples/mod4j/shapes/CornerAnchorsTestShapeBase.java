...
public class CornerAnchorsTestShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public CornerAnchorsTestShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "CornerAnchorsTest.containerShape");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "CornerAnchorsTest.shape_1");
