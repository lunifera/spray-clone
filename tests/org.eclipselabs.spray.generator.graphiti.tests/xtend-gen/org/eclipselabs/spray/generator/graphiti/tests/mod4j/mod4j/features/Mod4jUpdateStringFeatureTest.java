...
public class Mod4jUpdateStringFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jUpdateStringFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jUpdateStringFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jUpdateStringFeature extends Mod4jUpdateStringFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jUpdateStringFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
