...
public class Mod4jUpdatePackageFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jUpdatePackageFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jUpdatePackageFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jUpdatePackageFeature extends Mod4jUpdatePackageFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jUpdatePackageFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
