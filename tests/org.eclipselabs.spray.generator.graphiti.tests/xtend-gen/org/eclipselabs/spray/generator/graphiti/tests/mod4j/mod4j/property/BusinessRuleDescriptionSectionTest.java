...
public class BusinessRuleDescriptionSectionTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type BusinessRuleDescriptionSectionTest"
      + "\nThe method assertEquals is undefined for the type BusinessRuleDescriptionSectionTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class BusinessRuleDescriptionSection extends BusinessRuleDescriptionSectionBase {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
