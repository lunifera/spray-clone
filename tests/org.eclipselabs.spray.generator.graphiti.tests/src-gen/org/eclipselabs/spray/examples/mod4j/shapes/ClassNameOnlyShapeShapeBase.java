...
public class ClassNameOnlyShapeShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
        textId1
    }
    
    public ClassNameOnlyShapeShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "ClassNameOnlyShape.containerShape");
    ...
    protected void createCascadedElements(Diagram diagram, ContainerShape containerShape, ISprayStyle sprayStyle) {
        ...
        gaService.setLocationAndSize(element_0, 0, 0, 100, 30);
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_2, "ClassNameOnlyShape.shape_2");
        ...
        gaService.setLocationAndSize(element_2, 0, 0, 50, 25);
        SprayLayoutService.setLayoutData(shape_2, 50, 25, true);
        element_2.setHorizontalAlignment(Orientation.ALIGNMENT_LEFT);
        element_2.setVerticalAlignment(Orientation.ALIGNMENT_TOP);
        peService.setPropertyValue(element_2, ISprayConstants.TEXT_ID, TextIds.textId1.name());
        peService.setPropertyValue(shape_2, ISprayConstants.TEXT_ID, TextIds.textId1.name());
        element_2.setValue("");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "ClassNameOnlyShape.shape_1");
        ...
        gaService.setLocationAndSize(element_1, 0, 0, 100, 30);
        SprayLayoutService.setLayoutData(shape_1, 100, 30, true);
