...
public class Mod4jResizeAutopackageFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jResizeAutopackageFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jResizeAutopackageFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jResizeAutopackageFeature extends Mod4jResizeAutopackageFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jResizeAutopackageFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
