...
public class BPMN_EventError_BoldInvertShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public BPMN_EventError_BoldInvertShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "BPMN_EventError_BoldInvert.containerShape");
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_2.add(gaService.createPoint(23, 10, 0, 0));
        pointList_2.add(gaService.createPoint(32, 25, 0, 0));
        pointList_2.add(gaService.createPoint(42, 10, 0, 0));
        pointList_2.add(gaService.createPoint(32, 40, 0, 0));
        pointList_2.add(gaService.createPoint(20, 25, 0, 0));
        pointList_2.add(gaService.createPoint(8, 40, 0, 0));
        ContainerShape shape_2 = peCreateService.createContainerShape(parentShape, false);
        SprayLayoutService.setId(shape_2, "BPMN_EventError_BoldInvert.shape_2");
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "BPMN_EventError_BoldInvert.shape_1");
