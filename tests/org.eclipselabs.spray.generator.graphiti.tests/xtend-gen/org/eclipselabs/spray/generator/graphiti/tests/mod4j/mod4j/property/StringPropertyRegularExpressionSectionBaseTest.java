...
public class StringPropertyRegularExpressionSectionBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type StringPropertyRegularExpressionSectionBaseTest"
      + "\nThe method assertEquals is undefined for the type StringPropertyRegularExpressionSectionBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class StringPropertyRegularExpressionSectionBase extends GFPropertySection implements ITabbedPropertyConstants {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected StringProperty bc = null;");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected Text           regularExpressionWidget;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("/**");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("regularExpressionWidget = factory.createText(composite, \"\");");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("regularExpressionWidget.setLayoutData(data);");
    _builder.newLine();
    _builder.newLine();
    _builder.append("        ");
    _builder.append("CLabel valueLabel = factory.createCLabel(composite, \"RegularExpression\");");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("data = new FormData();");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("data.right = new FormAttachment(regularExpressionWidget, -HSPACE);");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("data.top = new FormAttachment(regularExpressionWidget, 0, SWT.CENTER);");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("regularExpressionWidget.removeModifyListener(nameListener);");
    _builder.newLine();
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("            ");
    _builder.append("// the filter assured, that it is a StringProperty");
    _builder.newLine();
    _builder.append("            ");
    ...
    _builder.newLine();
    _builder.append("            ");
    _builder.append("bc = (StringProperty) bo;");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("String value = \"\";");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("value = bc.getRegularExpression();");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("regularExpressionWidget.setText(value == null ? \"\" : value);");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("regularExpressionWidget.addModifyListener(nameListener);");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("String newValue = regularExpressionWidget.getText();");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("if (!newValue.equals(bc.getRegularExpression())) {");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("bc.setRegularExpression(newValue);");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("}");
    _builder.newLine();
