...
public class StringPropertyDescriptionSectionTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type StringPropertyDescriptionSectionTest"
      + "\nThe method assertEquals is undefined for the type StringPropertyDescriptionSectionTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class StringPropertyDescriptionSection extends StringPropertyDescriptionSectionBase {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
