...
public class TextShapeShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
        textId2
    }
    
    public TextShapeShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "TextShape.containerShape");
    ...
    protected void createCascadedElements(Diagram diagram, ContainerShape containerShape, ISprayStyle sprayStyle) {
        ...
        gaService.setLocationAndSize(element_0, 0, 0, 80, 25);
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "TextShape.shape_1");
        Text element_1 = gaService.createPlainText(shape_1);
        ISprayStyle style_1 = new org.eclipselabs.spray.examples.mod4j.styles.MydiagramDefaultStyle();
        element_1.setStyle(style_1.getStyle(diagram));
        gaService.setLocationAndSize(element_1, 0, 0, 80, 25);
        SprayLayoutService.setLayoutData(shape_1, 80, 25, true);
        element_1.setHorizontalAlignment(Orientation.ALIGNMENT_LEFT);
        element_1.setVerticalAlignment(Orientation.ALIGNMENT_TOP);
        peService.setPropertyValue(element_1, ISprayConstants.TEXT_ID, TextIds.textId2.name());
        peService.setPropertyValue(shape_1, ISprayConstants.TEXT_ID, TextIds.textId2.name());
        element_1.setValue("");
        getFeatureProvider().getDirectEditingInfo().setGraphicsAlgorithm(element_1);
        return shape_1;
    }
