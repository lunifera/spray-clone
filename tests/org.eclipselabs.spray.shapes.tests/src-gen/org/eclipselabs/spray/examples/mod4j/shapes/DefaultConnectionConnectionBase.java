...
public class DefaultConnectionConnectionBase extends DefaultSprayConnection {
	...
	public static enum TextIds {
	   ...
	   public DefaultConnectionConnectionBase(final IFeatureProvider fp) {
	super(fp);
	}
	...
	protected ConnectionDecorator createDecorator_1(Diagram diagram, Connection connection, ISprayStyle sprayStyle) {
		...
		pointList.add(gaService.createPoint(0, 0, 30, 30));
		pointList.add(gaService.createPoint(100, 0, 30, 30);
		pointList.add(gaService.createPoint(100, 100, 30, 30);
		pointList.add(gaService.createPoint(0, 100, 30, 30);
