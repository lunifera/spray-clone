...
public class Mod4jDirectEditAssociationFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jDirectEditAssociationFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jDirectEditAssociationFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class Mod4jDirectEditAssociationFeatureBase extends AbstractDirectEditingFeature {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jDirectEditAssociationFeatureBase(IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("// support direct editing, if it is a Association, and the user clicked");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("// directly on the text and not somewhere else in the rectangle");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("if (bo instanceof Association && ga instanceof AbstractText) {");
    _builder.newLine();
    _builder.append("            ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("// return the initial value of the clicked text on the Association");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("PictogramElement pe = context.getPictogramElement();");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("Association eClass = (Association) getBusinessObjectForPictogramElement(pe);");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("// set the new value on the Association");
    _builder.newLine();
    _builder.append("        ");
