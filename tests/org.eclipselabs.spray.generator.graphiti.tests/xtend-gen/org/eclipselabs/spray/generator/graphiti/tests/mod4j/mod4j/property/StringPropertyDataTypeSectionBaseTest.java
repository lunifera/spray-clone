...
public class StringPropertyDataTypeSectionBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type StringPropertyDataTypeSectionBaseTest"
      + "\nThe method assertEquals is undefined for the type StringPropertyDataTypeSectionBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class StringPropertyDataTypeSectionBase extends GFPropertySection implements ITabbedPropertyConstants {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected Text     dataTypeWidget;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("/**");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("dataTypeWidget = factory.createText(composite, \"\");");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("dataTypeWidget.setLayoutData(data);");
    _builder.newLine();
    _builder.newLine();
    _builder.append("        ");
    _builder.append("CLabel valueLabel = factory.createCLabel(composite, \"DataType\");");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("data = new FormData();");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("data.right = new FormAttachment(dataTypeWidget, -HSPACE);");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("data.top = new FormAttachment(dataTypeWidget, 0, SWT.CENTER);");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("dataTypeWidget.removeModifyListener(nameListener);");
    _builder.newLine();
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("            ");
    _builder.append("value = bc.getDataType();");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("dataTypeWidget.setText(value == null ? \"\" : value);");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("dataTypeWidget.addModifyListener(nameListener);");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("String newValue = dataTypeWidget.getText();");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("if (!newValue.equals(bc.getDataType())) {");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("bc.setDataType(newValue);");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("}");
    _builder.newLine();
