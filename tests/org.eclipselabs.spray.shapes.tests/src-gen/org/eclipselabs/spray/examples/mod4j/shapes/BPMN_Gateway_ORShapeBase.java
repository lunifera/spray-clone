...
public class BPMN_Gateway_ORShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public BPMN_Gateway_ORShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "BPMN_Gateway_OR.containerShape");
    ...
    protected Shape createElement_2(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_2, "BPMN_Gateway_OR.shape_2");
        ...
        gaService.setLocationAndSize(element_2, 15, 15, 30, 30);
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        pointList_1.add(gaService.createPoint(60, 25, 0, 0));
        ...
        SprayLayoutService.setId(shape_1, "BPMN_Gateway_OR.shape_1");
