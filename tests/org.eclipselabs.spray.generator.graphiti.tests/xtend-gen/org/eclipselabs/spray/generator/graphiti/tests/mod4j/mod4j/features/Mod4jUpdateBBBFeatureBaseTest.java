...
public class Mod4jUpdateBBBFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jUpdateBBBFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jUpdateBBBFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class Mod4jUpdateBBBFeatureBase extends AbstractUpdateFeature {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jUpdateBBBFeatureBase(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
