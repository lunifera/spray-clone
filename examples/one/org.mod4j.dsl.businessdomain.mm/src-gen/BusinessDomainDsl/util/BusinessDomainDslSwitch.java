...
public class BusinessDomainDslSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case BusinessDomainDslPackage.PACKAGE:
      {
        BusinessDomainDsl.Package package_ = (BusinessDomainDsl.Package)theEObject;
   ...
   * @generated
   */
  public T casePackage(BusinessDomainDsl.Package object)
  {
    return null;
  }
