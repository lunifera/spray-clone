...
public class RelativeAnchorsTestShapeBase extends DefaultSprayShape {
    
    public static enum TextIds {
    }
    
    public RelativeAnchorsTestShapeBase(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public ContainerShape getShape(ContainerShape targetContainer, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(containerShape, "RelativeAnchorsTest.containerShape");
    ...
    protected void createCascadedElements(Diagram diagram, ContainerShape containerShape, ISprayStyle sprayStyle) {
        ...
        gaService.setLocationAndSize(element_0, 0, 0, 0, 0);
    ...
    protected Shape createElement_1(Diagram diagram,  ContainerShape parentShape, ISprayStyle sprayStyle) {
        ...
        SprayLayoutService.setId(shape_1, "RelativeAnchorsTest.shape_1");
        ...
        gaService.setLocationAndSize(element_1, 0, 0, 0, 0);
        SprayLayoutService.setLayoutData(shape_1, 0, 0, true);
        return shape_1;
    }
