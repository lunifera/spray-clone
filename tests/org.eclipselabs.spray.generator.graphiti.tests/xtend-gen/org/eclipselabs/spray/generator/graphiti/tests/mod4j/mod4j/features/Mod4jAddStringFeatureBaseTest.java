...
public class Mod4jAddStringFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jAddStringFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jAddStringFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.append("public abstract class Mod4jAddStringFeatureBase extends AbstractAddFeature {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected final static String typeOrAliasName = \"String\";");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jAddStringFeatureBase(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("if (newObject instanceof StringProperty) {");
    _builder.newLine();
    _builder.append("            ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("final StringProperty addedModelElement = (StringProperty) context.getNewObject();");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("// NEW stuff");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("peService.setPropertyValue(conShape , PROPERTY_ALIAS, \"String\");");
    _builder.newLine();
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected void linkShapes(ContainerShape conShape, StringProperty addedModelElement) {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("link(conShape, addedModelElement);");
    _builder.newLine();
