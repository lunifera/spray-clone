...
public class Mod4jAddAutopackageFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jAddAutopackageFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jAddAutopackageFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jAddAutopackageFeature extends Mod4jAddAutopackageFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jAddAutopackageFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
