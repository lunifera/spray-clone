...
public class Mod4jResizeBoolPropertyFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jResizeBoolPropertyFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jResizeBoolPropertyFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jResizeBoolPropertyFeature extends Mod4jResizeBoolPropertyFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jResizeBoolPropertyFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
