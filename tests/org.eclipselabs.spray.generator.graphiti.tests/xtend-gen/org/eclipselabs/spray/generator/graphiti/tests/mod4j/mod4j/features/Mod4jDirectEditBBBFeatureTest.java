...
public class Mod4jDirectEditBBBFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jDirectEditBBBFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jDirectEditBBBFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jDirectEditBBBFeature extends Mod4jDirectEditBBBFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jDirectEditBBBFeature(IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
