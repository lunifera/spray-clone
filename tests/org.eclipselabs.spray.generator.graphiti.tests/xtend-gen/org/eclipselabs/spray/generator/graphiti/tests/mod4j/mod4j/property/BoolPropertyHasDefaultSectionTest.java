...
public class BoolPropertyHasDefaultSectionTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type BoolPropertyHasDefaultSectionTest"
      + "\nThe method assertEquals is undefined for the type BoolPropertyHasDefaultSectionTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class BoolPropertyHasDefaultSection extends BoolPropertyHasDefaultSectionBase {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
