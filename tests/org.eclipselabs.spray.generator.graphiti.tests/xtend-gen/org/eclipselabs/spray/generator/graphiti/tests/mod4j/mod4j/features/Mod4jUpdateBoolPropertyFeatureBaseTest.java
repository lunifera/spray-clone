...
public class Mod4jUpdateBoolPropertyFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jUpdateBoolPropertyFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jUpdateBoolPropertyFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class Mod4jUpdateBoolPropertyFeatureBase extends AbstractUpdateFeature {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jUpdateBoolPropertyFeatureBase(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("// return true, if linked business object is a BoolProperty");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("return (bo instanceof BoolProperty) && (!(pictogramElement instanceof Diagram));");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("if (!(bo instanceof BoolProperty)) {");
    _builder.newLine();
    _builder.append("            ");
    ...
    _builder.newLine();
    _builder.append("            ");
    _builder.append("BoolProperty eClass = (BoolProperty) bo;");
    _builder.newLine();
    _builder.append("            ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected boolean checkUpdateNeededRecursively(Shape shape, final BoolProperty eClass) {");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("final BoolProperty eClass = (BoolProperty) getBusinessObjectForPictogramElement(pictogramElement);");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("if (pictogramElement instanceof Shape) {");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected void updateChildrenRecursively(Shape shape, final BoolProperty eClass) {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("GraphicsAlgorithm graphicsAlgorithm = shape.getGraphicsAlgorithm();");
    _builder.newLine();
