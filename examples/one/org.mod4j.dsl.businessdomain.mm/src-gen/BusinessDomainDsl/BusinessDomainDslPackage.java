 ...
 * @model kind="package"
 *        annotation="http://www.eclipse.org/emf/2002/GenModel modelDirectory='/org.mod4j.dsl.businessdomain.mm/src-gen' importerID='org.eclipse.emf.importer.ecore' complianceLevel='5.0' interfaceNamePattern='{0}' classNamePattern=''"
 * @generated
 */
public interface BusinessDomainDslPackage extends EPackage
{
   ...
   * @ordered
   */
  int BUSINESS_DOMAIN_MODEL__PACKAGES = MODEL_ELEMENT_FEATURE_COUNT + 3;
   ...
   * @ordered
   */
  int BUSINESS_DOMAIN_MODEL_FEATURE_COUNT = MODEL_ELEMENT_FEATURE_COUNT + 4;

  /**
   * The number of operations of the '<em>Business Domain Model</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int BUSINESS_DOMAIN_MODEL_OPERATION_COUNT = MODEL_ELEMENT_OPERATION_COUNT + 0;
   ...
   * @ordered
   */
  int ABSTRACT_TYPE_OPERATION_COUNT = MODEL_ELEMENT_OPERATION_COUNT + 0;
  ...
  /**
   * The number of operations of the '<em>Abstract Business Class</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int ABSTRACT_BUSINESS_CLASS_OPERATION_COUNT = ABSTRACT_TYPE_OPERATION_COUNT + 0;
   ...
   * @ordered
   */
  int BUSINESS_CLASS_OPERATION_COUNT = ABSTRACT_BUSINESS_CLASS_OPERATION_COUNT + 0;
   ...
   * @ordered
   */
  int ENUMERATION_OPERATION_COUNT = MODEL_ELEMENT_OPERATION_COUNT + 0;
  ...
  /**
   * The number of operations of the '<em>Abstract Business Rule</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int ABSTRACT_BUSINESS_RULE_OPERATION_COUNT = MODEL_ELEMENT_OPERATION_COUNT + 0;
  ...
  /**
   * The number of operations of the '<em>Date Time Property</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int DATE_TIME_PROPERTY_OPERATION_COUNT = PROPERTY_OPERATION_COUNT + 0;
  ...
  /**
   * The number of operations of the '<em>Enumeration Property</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int ENUMERATION_PROPERTY_OPERATION_COUNT = PROPERTY_OPERATION_COUNT + 0;
  ...
  /**
   * The number of operations of the '<em>Blob Binary Property</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int BLOB_BINARY_PROPERTY_OPERATION_COUNT = PROPERTY_OPERATION_COUNT + 0;
  ...
  /**
   * The number of operations of the '<em>Blob Text Property</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int BLOB_TEXT_PROPERTY_OPERATION_COUNT = PROPERTY_OPERATION_COUNT + 0;
  ...
  /**
   * The number of operations of the '<em>Decimal Property</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int DECIMAL_PROPERTY_OPERATION_COUNT = PROPERTY_OPERATION_COUNT + 0;
  ...
  /**
   * The number of operations of the '<em>Business Class Reference</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int BUSINESS_CLASS_REFERENCE_OPERATION_COUNT = ABSTRACT_BUSINESS_CLASS_OPERATION_COUNT + 0;
  ...
  /**
   * The number of operations of the '<em>Unique Rule</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int UNIQUE_RULE_OPERATION_COUNT = ABSTRACT_BUSINESS_RULE_OPERATION_COUNT + 0;
   ...
   * @ordered
   */
  int BUSINESS_RULE_OPERATION_COUNT = ABSTRACT_BUSINESS_RULE_OPERATION_COUNT + 0;

  /**
   * The meta object id for the '{@link BusinessDomainDsl.impl.PackageImpl <em>Package</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see BusinessDomainDsl.impl.PackageImpl
   * @see BusinessDomainDsl.impl.BusinessDomainDslPackageImpl#getPackage()
   * @generated
   */
  int PACKAGE = 21;
   ...
   * @ordered
   */
  int PACKAGE__CLASSES = MODEL_ELEMENT_FEATURE_COUNT + 0;
  ...
  /**
   * Returns the meta object for the containment reference list '{@link BusinessDomainDsl.BusinessDomainModel#getPackages <em>Packages</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Packages</em>'.
   * @see BusinessDomainDsl.BusinessDomainModel#getPackages()
   * @see #getBusinessDomainModel()
   * @generated
   */
  EReference getBusinessDomainModel_Packages();
  ...
  /**
   * Returns the meta object for class '{@link BusinessDomainDsl.Package <em>Package</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Package</em>'.
   * @see BusinessDomainDsl.Package
   * @generated
   */
  EClass getPackage();

  /**
   * Returns the meta object for the containment reference list '{@link BusinessDomainDsl.Package#getClasses <em>Classes</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Classes</em>'.
   * @see BusinessDomainDsl.Package#getClasses()
   * @see #getPackage()
   * @generated
   */
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference BUSINESS_DOMAIN_MODEL__PACKAGES = eINSTANCE.getBusinessDomainModel_Packages();
    ...
    /**
     * The meta object literal for the '{@link BusinessDomainDsl.impl.PackageImpl <em>Package</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see BusinessDomainDsl.impl.PackageImpl
     * @see BusinessDomainDsl.impl.BusinessDomainDslPackageImpl#getPackage()
