...
public class Mod4jLayoutBusinessClassFeatureTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jLayoutBusinessClassFeatureTest"
      + "\nThe method assertEquals is undefined for the type Mod4jLayoutBusinessClassFeatureTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Mod4jLayoutBusinessClassFeature extends Mod4jLayoutBusinessClassFeatureBase {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jLayoutBusinessClassFeature(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
