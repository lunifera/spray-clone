...
public class Mod4jMoveBusinessClassFeatureBaseTest extends AbstractSprayGeneratorTest {
  /* @Test
   */public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method assertTrue is undefined for the type Mod4jMoveBusinessClassFeatureBaseTest"
      + "\nThe method assertEquals is undefined for the type Mod4jMoveBusinessClassFeatureBaseTest");
  }
  ...
  private CharSequence expectedContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public abstract class Mod4jMoveBusinessClassFeatureBase extends DefaultMoveShapeFeature {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Mod4jMoveBusinessClassFeatureBase(final IFeatureProvider fp) {");
    _builder.newLine();
    _builder.append("        ");
